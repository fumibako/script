tyrano.plugin.kag = {
  ...
  init_game: function () {
    ...
    if (this.kag.config["useCamera"] && this.kag.config["useCamera"] == "true") this.kag.config["ScreenCentering"] = "false";
    ...
    if ($("#first_scenario_file").size() > 0) first_scenario_file = $("#first_scenario_file").val();
