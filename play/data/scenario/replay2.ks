...
[else]
[button name=rp_bt graphic="../fgimage/bg/cg_bg.jpg" storage="replay2.ks" target="*no_image" x=270 y=60 width=200 height=130]
[endif]
...
[else]
[button name=rp_bt graphic="../fgimage/bg/cg_bg.jpg" storage="replay2.ks" target="*no_image" x=490 y=60 width=200 height=130]
[endif]
...
[else]
[button name=rp_bt x=50 y=240 width=200 height=130 graphic="../fgimage/bg/cg_bg.jpg" storage="replay2.ks" target="*no_image" folder="bgimage"]
[endif]
...
[else]
[button name=rp_bt x=270 y=240 width=200 height=130 graphic="../fgimage/bg/cg_bg.jpg" storage="replay2.ks" target="*no_image"]
[endif]
...
[else]
[button name=rp_bt x=490 y=240 width=200 height=130 graphic="../fgimage/bg/cg_bg.jpg" storage="replay2.ks" target="*no_image"]
[endif]
