...
;[replay_image_button2 end=&sf.ED_hujieda_bad2 storage="hujieda/hujieda_11_3_badED.ks" target="*replay_hujieda_badED_scene2" graphic="../fgimage/bg/replay_hujieda_badED2.jpg" x=490 y=240 width=200 height=130 folder="bgimage"]
...
;[ptext name=list layer=2 page=fore text="？ルート　:　badEND" x=710 y=380 size=17 color=navy visible=true]
[endif]
