...
;[glink target="mayu_07" text="[葛城宮眉平行]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=210 color=white]
...
*mayu_07
[葛城宮眉平行]
[eval exp="f.gra_katuraginomiya_face='眉：[葛城宮眉平行]'"]
@jump target=text
...
*kuti_07
[葛城宮口大開]
[eval exp="f.gra_katuraginomiya_face='口：[葛城宮口大開]'"]
@jump target=text
