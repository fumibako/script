...
[ptext text="藤枝の手紙イベントをみた(0=未見、1=見た)" layer=29 size=15 x=700 y=290 color=darkslateblue bold=bold]
[ptext text="手紙1:" layer=29 size=10 x=690 y=310 color=darkslateblue bold=bold]
[edit left=710 top=340 width=40 length=200 maxchars=3 name="f.event_hujieda1" height=20]
[ptext text="手紙2:" layer=29 size=10 x=760 y=310 color=darkslateblue bold=bold]
[edit left=760 top=340 width=40 length=200 maxchars=3 name="f.event_hujieda2" height=20]
[ptext text="手紙3:" layer=29 size=10 x=810 y=310 color=darkslateblue bold=bold]
[edit left=810 top=340 width=40 length=200 maxchars=3 name="f.event_hujieda3" height=20]
[ptext text="手紙4:" layer=29 size=10 x=852 y=310 color=darkslateblue bold=bold]
[edit left=852 top=340 width=40 length=200 maxchars=3 name="f.event_hujieda4" height=20]
[ptext text="返事EV:" layer=29 size=10 x=900 y=310 color=darkslateblue bold=bold]
