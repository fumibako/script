...
[ptext text="手紙1:" layer=29 size=15 x=690 y=300 color=darkslateblue bold=bold]
[edit left=710 top=320 width=40 length=200 maxchars=3 name="f.event_hujieda1" height=20]
[ptext text="手紙2:" layer=29 size=15 x=710 y=300 color=darkslateblue bold=bold]
[edit left=760 top=320 width=40 length=200 maxchars=3 name="f.event_hujieda2" height=20]
[ptext text="手紙3:" layer=29 size=15 x=720 y=300 color=darkslateblue bold=bold]
[edit left=810 top=320 width=40 length=200 maxchars=3 name="f.event_hujieda3" height=20]
[ptext text="手紙4:" layer=29 size=15 x=730 y=440 color=darkslateblue bold=bold]
[edit left=850 top=320 width=40 length=200 maxchars=3 name="f.event_hujieda4" height=20]
[ptext text="返事EV:" layer=29 size=15 x=740 y=300 color=darkslateblue bold=bold]
[edit left=900 top=320 width=40 length=200 maxchars=3 name="f.event_hujieda5" height=20]
