...
[ptext text="藤枝の手紙イベントをみた(0=未見、1=見た)" layer=29 size=10 x=700 y=290 color=darkslateblue bold=bold]
[ptext text="手紙1:" layer=29 size=15 x=700 y=300 color=darkslateblue bold=bold]
[edit left=710 top=300 width=50 length=200 maxchars=3 name="f.event_hujieda1" height=20]
[ptext text="手紙2:" layer=29 size=15 x=700 y=340 color=darkslateblue bold=bold]
[edit left=760 top=300 width=50 length=200 maxchars=3 name="f.event_hujieda2" height=20]
[ptext text="手紙3:" layer=29 size=15 x=700 y=390 color=darkslateblue bold=bold]
[edit left=810 top=300 width=50 length=200 maxchars=3 name="f.event_hujieda3" height=20]
[ptext text="手紙4:" layer=29 size=15 x=700 y=440 color=darkslateblue bold=bold]
[edit left=890 top=300 width=50 length=200 maxchars=3 name="f.event_hujieda4" height=20]
[ptext text="返事EV:" layer=29 size=15 x=700 y=490 color=darkslateblue bold=bold]
[edit left=940 top=300 width=50 length=200 maxchars=3 name="f.event_hujieda5" height=20]
