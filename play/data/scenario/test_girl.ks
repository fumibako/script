...
[glink name=list target="pose_02" text="[主人公ポーズ片手]" graphic="select_waku_x500.png" size=15 width="160" x=0 y=180 font_color=black]
[glink name=list target="pose_03" text="[主人公ポーズ両手]" graphic="select_waku_x500.png" size=15 width="160" x=0 y=210 font_color=black]
[glink name=list target="pose_04" text="[主人公ポーズ指]" graphic="select_waku_x500.png" size=15 width="160" x=0 y=240 font_color=black]
[endif]

[if exp="f.gra_girl_base=='sED_pink'"]
[glink name=list target="pose_sPink_01" text="[主人公ポーズ四条ピンク通常]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=150 font_color=black]
[glink name=list target="pose_sPink_02" text="[主人公ポーズ四条ピンク指]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=180 font_color=black]
[endif]

[if exp="f.gra_girl_base=='sED_green'"]
[glink name=list target="pose_sGreen_01" text="[主人公ポーズ四条緑通常]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=150 font_color=black]
[glink name=list target="pose_sGreen_02" text="[主人公ポーズ四条緑指]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=180 font_color=black]
[endif]

[if exp="f.gra_girl_base=='sTenran'"]
[glink name=list target="pose_sPurple_01" text="[主人公ポーズ四条紫通常]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=150 font_color=black]
[glink name=list target="pose_sPurple_02" text="[主人公ポーズ四条紫指]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=180 font_color=black]
[glink name=list target="pose_sPurple_03" text="[主人公ポーズ四条紫片手]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=210 font_color=black]
[endif]

[if exp="f.gra_girl_base=='zED'"]
[glink name=list target="pose_zED_01" text="[主人公ポーズ財前ED通常]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=150 font_color=black]
[glink name=list target="pose_zED_02" text="[主人公ポーズ財前ED片手]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=180 font_color=black]
[glink name=list target="pose_zED_03" text="[主人公ポーズ財前ED両手]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=210 font_color=black]
[endif]

[if exp="f.gra_girl_base=='zDress'"]
[glink name=list target="pose_zDress_01" text="[主人公ポーズ財前ドレス通常]" graphic="select_waku_x500.png" size=13 width="160" x=0 y=150 font_color=black]
...
*pose_kKimono_01
[主人公ポーズ葛城宮白桜色通常]
[eval exp="f.gra_girl_pose='[主人公ポーズ葛城宮白桜色通常]'"]
@jump target=text

*pose_kED_01
[主人公ポーズ葛城宮ED通常]
[eval exp="f.gra_girl_pose='[主人公ポーズ葛城宮ED通常]'"]
@jump target=text
