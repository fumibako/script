...
[wait time=10]
[ptext text="◆I9IhvvVdPo様　スクリプト確認用" layer=26 size=21 x=100 y=20 color=darkslateblue bold=bold]
...
[glink target="sansaku01" text="共通散策イベント1『スポーツの話題』" graphic="select_waku_x500.png" size=20 width="500" x=100 y=100 font_color=black]
[glink target="sansaku02" text="共通散策イベント2『食事の話題』" graphic="select_waku_x500.png" size=20 width="500" x=100 y=150 font_color=black]
[glink target="sansaku03" text="共通散策イベント3『観劇の話題』" graphic="select_waku_x500.png" size=20 width="500" x=100 y=200 font_color=black]
[glink target="sansaku04" text="共通散策イベント4『読書の話題』" graphic="select_waku_x500.png" size=20 width="500" x=100 y=250 font_color=black]
[glink target="sansaku05" text="共通散策イベント5『写真の話題』" graphic="select_waku_x500.png" size=20 width="500" x=100 y=300 font_color=black]
;[glink target="sansaku06" text="共通散策イベント6" graphic="select_waku_x500.png" size=20 width="250" x=100 y=350 font_color=black]
;[glink target="sansaku07" text="共通散策イベント7" graphic="select_waku_x500.png" size=20 width="250" x=100 y=400 font_color=black]
;[glink target="sansaku08" text="共通散策イベント8" graphic="select_waku_x500.png" size=20 width="250" x=100 y=450 font_color=black]
;[glink target="sansaku09" text="共通散策イベント9" graphic="select_waku_x500.png" size=20 width="250" x=100 y=500 font_color=black]
;[glink target="sansaku10" text="共通散策イベント10" graphic="select_waku_x500.png" size=20 width="250" x=100 y=550 font_color=black]
...
[cm]
[freeimage layer = 26]
@jump storage="01_I9IhvvVdPo_sansaku.ks" target="*sansaku_machi_common_I9IhvvVdPo_06"
[s]

*sansaku07
[cm]
[freeimage layer = 26]
@jump storage="01_I9IhvvVdPo_sansaku.ks" target="*sansaku_machi_common_I9IhvvVdPo_07"
[s]

*sansaku08
[cm]
[freeimage layer = 26]
@jump storage="01_I9IhvvVdPo_sansaku.ks" target="*sansaku_machi_common_I9IhvvVdPo_08"
[s]

*sansaku09
[cm]
[freeimage layer = 26]
@jump storage="01_I9IhvvVdPo_sansaku.ks" target="*sansaku_machi_common_I9IhvvVdPo_09"
[s]

*sansaku10
[cm]
[freeimage layer = 26]
@jump storage="01_I9IhvvVdPo_sansaku.ks" target="*sansaku_machi_common_I9IhvvVdPo_10"
[s]
