...
[glink target="sansaku01" text="共通散策イベント1" graphic="select_waku_x500.png" size=20 width="250" x=100 y=100 color=white]
[glink target="sansaku02" text="共通散策イベント2" graphic="select_waku_x500.png" size=20 width="250" x=100 y=150 color=white]
[glink target="sansaku03" text="共通散策イベント3" graphic="select_waku_x500.png" size=20 width="250" x=100 y=200 color=white]
[glink target="sansaku04" text="共通散策イベント4" graphic="select_waku_x500.png" size=20 width="250" x=100 y=250 color=white]
[glink target="sansaku05" text="共通散策イベント5" graphic="select_waku_x500.png" size=20 width="250" x=100 y=300 color=white]
[glink target="sansaku06" text="共通散策イベント6" graphic="select_waku_x500.png" size=20 width="250" x=100 y=350 color=white]
[glink target="sansaku07" text="共通散策イベント7" graphic="select_waku_x500.png" size=20 width="250" x=100 y=400 color=white]
;[glink target="sansaku08" text="共通散策イベント8" graphic="select_waku_x500.png" size=20 width="250" x=100 y=450 color=white]
;[glink target="sansaku09" text="共通散策イベント9" graphic="select_waku_x500.png" size=20 width="250" x=100 y=500 color=white]
;[glink target="sansaku10" text="共通散策イベント10" graphic="select_waku_x500.png" size=20 width="250" x=100 y=550 color=white]
