...
[ptext layer=2 page=fore text="四条ルート　:　badEND" x=470 y=390 size=17 color=navy visible=true]
...
[ptext layer=2 page=fore text="財前ルート　:　badEND1" x=470 y=600 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="財前ルート　:　badEND2" x=750 y=600 size=17 color=navy visible=true]
