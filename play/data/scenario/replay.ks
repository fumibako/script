...
*page_0
[replay_image_button name="kuroda_3_4_normalED_scene" graphic="../fgimage/bg/replay_kuroda_normalED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=50 y=100 width=200 height=130 folder="bgimage"]
[replay_image_button name="kuroda_3_4_goodED_scene" graphic="../fgimage/bg/replay_kuroda_goodED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=300 y=100 width=200 height=130 folder="bgimage"]
[replay_image_button name="replay_kuroda_12_3_badED_scene" graphic="../fgimage/bg/replay_kuroda_badED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=550 y=100 width=200 height=130 folder="bgimage"]
...
[replay_image_button name="replay_sijyou_3_4_normalED_scene" graphic="../fgimage/bg/sijyou_CGnomal.png" no_graphic="../fgimage/bg/cg_bg.jpg" x=50 y=290 width=200 height=130 folder="bgimage"]
[replay_image_button name="replay_sijyou_3_4_goodED_scene" graphic="../fgimage/bg/sijyou_CGgood.png" no_graphic="../fgimage/bg/cg_bg.jpg" x=300 y=290 width=200 height=130 folder="bgimage"]
[replay_image_button name="replay_sijyou_10_3badED_scene" graphic="../fgimage/bg/replay_sijyou_badlED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=550 y=290 width=200 height=130 folder="bgimage"]
[ptext layer=2 page=fore text="四条ルート　:　normalEND" x=50 y=440 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="四条ルート　:　goodEND" x=300 y=440 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="四条ルート　:　badEND" x=550 y=440 size=17 color=navy visible=true]

[replay_image_button name="replay_zaizen_3_4_normal_scene" graphic="../fgimage/bg/replay_zaizem_3_4_normalED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=50 y=590 width=200 height=130 folder="bgimage"]
[replay_image_button name="replay_zaizen_3_4_good_scene" graphic="../fgimage/bg/replay_zaizem_3_4_goodED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=300 y=590 width=200 height=130 folder="bgimage"]
[replay_image_button name="replay_zaizen_11_1_bad1_scene" graphic="../fgimage/bg/replay_zaizem_badED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=550 y=590 width=200 height=130 folder="bgimage"]
[replay_image_button name="replay_zaizen_11_bad2_scene" graphic="../fgimage/bg/replay_zaizem_badED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=550 y=590 width=200 height=130 folder="bgimage"]
