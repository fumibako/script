...
[ptext layer=2 page=fore text="黒田ルート　:　goodEND" x=270 y=210 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="黒田ルート　:　badEND" x=490 y=210 size=17 color=navy visible=true]
...
[ptext layer=2 page=fore text="四条ルート　:　goodEND" x=270 y=390 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="四条ルート　:　badEND" x=490 y=390 size=17 color=navy visible=true]
...
[replay_image_button name="replay_zaizen_3_4_good_scene" graphic="../fgimage/bg/zaizem_3_4_goodED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=270 y=420 width=200 height=130 folder="bgimage"]
...
[ptext layer=2 page=fore text="財前ルート　:　goodEND" x=270 y=600 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="財前ルート　:　badEND1" x=490 y=600 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="財前ルート　:　badEND2" x=710 y=600 size=17 color=navy visible=true]
