...
[replay_image_button name="replay_zaizen_11_1_bad1_scene" graphic="../fgimage/bg/replay_zaizem_badED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=480 y=590 width=200 height=130 folder="bgimage"]
[replay_image_button name="replay_zaizen_11_bad2_scene" graphic="../fgimage/bg/replay_zaizem_badED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=480 y=590 width=200 height=130 folder="bgimage"]
[ptext layer=2 page=fore text="財前ルート　:　normalEND" x=50 y=600 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="財前ルート　:　goodEND" x=300 y=600 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="財前ルート　:　badEND" x=550 y=600 size=17 color=navy visible=true]
[ptext layer=2 page=fore text="財前ルート　:　badEND2" x=550 y=600 size=17 color=navy visible=true]
