...
[cg_image_button graphic="../fgimage/bg/sijyou_CGnomal.jpg" no_graphic="../fgimage/bg/sijyou_CGnomal.png" x=540 y=100 width=210 height=140 folder="fgimage/bg" ]
[cg_image_button graphic="../fgimage/bg/sijyou_CGgood.jpg" no_graphic="../fgimage/bg/sijyou_CGgood.png" x=780 y=100 width=210 height=140 folder="fgimage/bg" ]
[ptext layer=1 page=fore text="四条ルート　:　normalEND" x=560 y=250 size=17 color=navy visible=true]
[ptext layer=1 page=fore text="四条ルート　:　goodEND" x=780 y=250 size=17 color=navy visible=true]
...
;[cg_image_button graphic="katuraginomiya_3_4_nomalED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=360 y=100 width=210 height=140 folder="fgimage/bg" ]
;[cg_image_button graphic="katuraginomiya_3_4_goodED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=500 y=100 width=210 height=140 folder="fgimage/bg" ]
...
;[cg_image_button graphic="hujieda_normalED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=60 y=100 width=210 height=140 folder="fgimage/bg" ]
;[cg_image_button graphic="hujieda_goodED.jpg" no_graphic="../fgimage/bg/cg_bg.jpg" x=300 y=100 width=210 height=140 folder="fgimage/bg" ]
;[if exp="f.hujieda==au"]
