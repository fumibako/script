...
[if exp="f.okeiko_month==9 && f.event_machi_sijyou[1]==0"]
	@jump storage="sijyou_sansaku.ks" 
	;target=*sansaku
[endif]
;================================================
;◆四条イベント判定 sijyou_sansaku2.ks(9-2お見合い決定～9月末(銀座デート前まで)華道パラが上がる？華道展イベントフラグ2sijyou_sobo=true9
[if exp="f.okeiko_month==9 && f.event_machi_sijyou[2]==0"]
	[eval exp="f.event_machi_sijyou[2]=1"]
	@jump storage="sijyou_sansaku2.ks" 
	;target=*sansaku
[endif]
;================================================
;◆四条イベント判定 sijyou_sansaku3.ks(9-3園遊会～9月末(銀座デート前まで)華道パラが上がる？ 華道展イベントフラグ2sijyou_sobo=true)
[if exp="f.okeiko_month==9 && f.event_machi_sijyou[3]==0"]
	[eval exp="f.event_machi_sijyou[3]=1"]
	@jump storage="sijyou_sansaku3.ks" 
	;target=*sansaku
[endif]
;================================================
;◆四条イベント判定 sijyou_sansaku4.ks(11月3週～1月末)
[if exp="f.okeiko_month==11 && f.event_machi_sijyou[4]==0"]
...
[if exp="f.okeiko_month==9 && f.event_machi_sijyou[5]==0"]
...
[if exp="f.okeiko_month==11 && (f.para_sijyou_koukando > 30 || f.para_zaizen_koukando > 30 || f.para_kuroda_koukando > 30 || f.para_katuraginomiya_koukando > 30|| f.para_hujieda_koukando > 30) && f.event_machi_sijyou[6]==0"]
	@jump storage="sijyou_sansaku4.ks" 
	;target=*sansaku
[endif]
;================================================
;◆四イベント判定条 sijyou_sansaku7.ks(３月華道パラメータ一定値以上、四条好感度一定値以上)
[if exp="f.okeiko_month==11 && f.event_machi_sijyou[7]==0"]
	@jump storage="sijyou_sansaku4.ks" 
	;target=*sansaku
[endif]
;================================================
;8ない。（旧華衣おまけ）
;[if exp="f.okeiko_month==11 && f.event_machi_sijyou[8]==0"]
;@jump storage="sijyou_sansaku8.ks" 
;target=*sansaku
;[endif]
;================================================
...
[endif]
;================================================
;◆四条イベント判定 sijyou_sansaku10.ks(いつでも　四条の好感度が高い攻略のヒント)
[if exp="f.okeiko_month > 9 && f.sijyou_au==1 && f.event_machi_sijyou[10]==0"]
	@jump storage="sijyou_sansaku10.ks" 
	;target=*sansaku
[endif]
;================================================
