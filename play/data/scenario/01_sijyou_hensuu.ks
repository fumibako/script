...
sf.sijyou ={
  ...
  "namae":"華織",
  "fullname":"四条 華織",
  "koukando_a":40, //その攻略対象が"親しい"態度に変わる好感度の数値です。自由に設定してください(好感度がこの設定数値以上になると、こちらから手紙を出した際の攻略対象から手紙が届くまでの期間が1週早くなる)
...
f.para_sijyou_koukando=40; //←攻略対象好感度初期値です。自由に変更してください＿！！テスト中早くします！！！
