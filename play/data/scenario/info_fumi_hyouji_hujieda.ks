...
[if exp="f.midoku_list_hairetsu[f.fumi_hairetsu1][f.fumi_hairetsu2] > 0"]
	[ptext name="list" text="未読" layer=28 size=15 x=500 y=&f.fumi_hujieda_midoku_y color=mediumslateblue bold=bold]
[endif]

;◆返信ボタンを必要時に表示
[if exp="f.hensin_list_hairetsu[f.fumi_hairetsu1][f.fumi_hairetsu2] == 1"]
	[ptext name="list" text="返信済" layer=28 size=15 x=865 y=&f.fumi_hujieda_midoku_y color=mediumslateblue bold=bold]
...
;藤枝文通可能期間(返信ボタン表示)は個別ルートに入った後、9月2週～10月4週と2月3週以降。11月1週(発覚)～2月2週は表示しない
	...
	[glink name="list" storage=&f.fumi_henji_storage target=&f.fumi_henji_target text="返信" exp="f.fumi_henjityu=1" size=16 width="32" x=860 y=&f.fumi_hujieda_y graphic="select_waku_x135.png" font_color=black]
...
[else]
	[glink name="list" storage="hujieda/hujieda_fumi.ks" target=&f.fumi_list_hujieda_target[f.list_count] text=&f.fumi_list_hujieda_title[f.list_count] size=16 width="260" x=535 y=&f.fumi_hujieda_y graphic="select_waku_x550_fuutou.png" font_color=black]
[endif]
