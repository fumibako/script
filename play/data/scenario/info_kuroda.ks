...
[freeimage layer = 27]
[freeimage layer = 28]
[eval exp="f.viewing_storage = 'info_kuroda.ks'"]
...
[if exp="f.fumi_kuroda_number > 5"]
			[glink name="list" storage="info_kuroda.ks" target=*fumi_kuroda_page2 text="→" size=20 width="20" x=855 y=480 graphic="select_waku_x150.png" font_color=black]
[endif]
...
[glink name="list" storage="info_kuroda.ks" target=*info_kuroda text="←" size=20 width="20" x=510 y=480 graphic="select_waku_x150.png" font_color=black]
[if exp="f.fumi_kuroda_number>10"]
[glink name="list" storage="info_kuroda.ks" target=*fumi_kuroda_page3 text="→" size=20 width="20" x=855 y=480 graphic="select_waku_x150.png" font_color=black]
[endif]
...
;1f.fumi_kuroda_number=[emb exp ="f.fumi_kuroda_number"][r]
[glink name="list" storage="info_kuroda.ks" target=*fumi_kuroda_page2 text="←" size=20 width="20" x=510 y=480 graphic="select_waku_x150.png" font_color=black]
