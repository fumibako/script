...
[eval exp="tf.fumi_hyouji_hensin_x = 385"]
[eval exp="tf.fumi_hyouji_hensin_x2 = 395"]
...
[elsif exp="f.hensin_list_hairetsu[f.fumi_hairetsu1][f.fumi_hairetsu2] == 1"]
	[ptext name="list" text="返信済" layer=28 size=15 x=&tf.fumi_hyouji_hensin_x2 y=&f.fumi_all_midoku_y color=mediumslateblue bold=bold]
[elsif exp="f.hensin_list_hairetsu[f.fumi_hairetsu1][f.fumi_hairetsu2] == -1"]
...
[else]
	[glink name="list" storage=&f.fumi_list_all_storage[f.list_count] target=&f.fumi_list_all_target[f.list_count] text=&f.fumi_list_all_title[f.list_count] size=12.5 width="300" height=17 x=&tf.fumi_hyouji_title_x y=&f.fumi_all_y graphic="select_waku_x550_fuutou.png" font_color=black]
[endif]
