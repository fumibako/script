...
[if exp="(f.okeiko_month == 2 && f.okeiko_week == 2) && f.event_sijyou[17] == 0 && (f.sijyou_sobo != true) && f.para_shujinkou_j_reihou >= 10 && (f.event_sijyou_4 == 1 || f.event_sijyou_kai_jijyou == 1) && f.sijyou_au == 1"]
