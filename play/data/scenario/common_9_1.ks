...
[glink storage="hujieda/hujieda_9_1.ks" target=*replay_hujieda_9_1 text="お会いしない" font_color=black size=23 width="200" x=550 y=&f.common_9_1_y_right exp="f.hujieda_au = 1" graphic="select_waku_x500.png"]
[elsif exp="f.event_hujieda[5] == 1 && f.common_9_1_ninzuu >= 2"]
[glink storage="hujieda/hujieda_9_1.ks" target=*replay_hujieda_9_1 text="誰も選ばない" font_color=black size=23 width="200" x=550 y=&f.common_9_1_y_right exp="f.hujieda_au = 1" graphic="select_waku_x500.png"]
[endif]
[eval exp="f.common_9_1_y_left = f.common_9_1_y_left + 100"]
