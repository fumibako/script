...
中はもう半分ほど埋まっていて、きっと後半年もすれば[ruby text="ふた"]蓋が[r]
閉まらなくなるだろう。
[autosave]
[p]
...
[glink storage=&f.common_9_1_storage[0] target=&f.common_9_1_target[0] text=&f.common_9_1_oaite[0] font_color=black size=23 width="200" x=200 y=&f.common_9_1_y_left exp=&f.common_9_1_oaite_exp[0] graphic="select_waku_x300.png"]
[if exp="f.common_9_1_ninzuu >= 2"]
[glink storage=&f.common_9_1_storage[1] target=&f.common_9_1_target[1] text=&f.common_9_1_oaite[1] font_color=black size=23 width="200" x=550 y=&f.common_9_1_y_right exp=&f.common_9_1_oaite_exp[1] graphic="select_waku_x300.png"]
[endif]
[if exp="f.common_9_1_ninzuu >= 3"]
[eval exp="f.common_9_1_y_left = f.common_9_1_y_left + 100"]
[glink storage=&f.common_9_1_storage[2] target=&f.common_9_1_target[2] text=&f.common_9_1_oaite[2] font_color=black size=23 width="200" x=200 y=&f.common_9_1_y_left exp=&f.common_9_1_oaite_exp[2] graphic="select_waku_x300.png"]
[endif]
...
[glink storage="hujieda/hujieda_9_1.ks" target=*replay_hujieda_9_1 text="お会いしない" font_color=black size=23 width="200" x=550 y=&f.common_9_1_y_right exp="f.hujieda_au = 1" graphic="select_waku_x300.png"]
[elsif exp="f.event_hujieda[5] == 1 && f.common_9_1_ninzuu >= 2"]
[glink storage="hujieda/hujieda_9_1.ks" target=*replay_hujieda_9_1 text="誰も選ばない" font_color=black size=23 width="200" x=550 y=&f.common_9_1_y_right exp="f.hujieda_au = 1" graphic="select_waku_x300.png"]
[endif]
[eval exp="f.common_9_1_y_left = f.common_9_1_y_left + 100"]
[glink target=*horyuu text="もっと考えたい" font_color=black size=23 width="200" x=200 y=&f.common_9_1_y_left  graphic="select_waku_x500.png"]
[autosave]
[s]
...
[eval exp="f.common_9_1_y_left = 100"]
[eval exp="f.common_9_1_y_right = 100"]
[glink storage=&f.common_9_1_storage[0] target=&f.common_9_1_target[0] text=&f.common_9_1_oaite[0] font_color=black size=23 width="200" x=200 y=&f.common_9_1_y_left exp=&f.common_9_1_oaite_exp[0] graphic="select_waku_x500.png"]
[if exp="f.common_9_1_ninzuu >= 2"]
[glink storage=&f.common_9_1_storage[1] target=&f.common_9_1_target[1] text=&f.common_9_1_oaite[1] font_color=black size=23 width="200" x=550 y=&f.common_9_1_y_right exp=&f.common_9_1_oaite_exp[1] graphic="select_waku_x500.png"]
[endif]
[if exp="f.common_9_1_ninzuu >= 3"]
[eval exp="f.common_9_1_y_left = f.common_9_1_y_left + 100"]
[glink storage=&f.common_9_1_storage[2] target=&f.common_9_1_target[2] text=&f.common_9_1_oaite[2] font_color=black size=23 width="200" x=200 y=&f.common_9_1_y_left exp=&f.common_9_1_oaite_exp[2] graphic="select_waku_x500.png"]
[endif]
;藤枝イベント発生中の場合のみ「誰も選ばない」ボタン表示
[if exp="f.common_9_1_ninzuu >= 2"]
	[eval exp="f.common_9_1_y_right = f.common_9_1_y_right + 100"]
[endif]
[if exp="f.event_hujieda[5] == 1 && f.common_9_1_ninzuu == 1"]
[glink storage="hujieda/hujieda_9_1.ks" target=*replay_hujieda_9_1 text="会わない" font_color=black size=23 width="200" x=550 y=&f.common_9_1_y_right graphic="select_waku_x500.png"]
[elsif exp="f.event_hujieda[5] == 1 && f.common_9_1_ninzuu >= 2"]
[glink storage="hujieda/hujieda_9_1.ks" target=*replay_hujieda_9_1 text="誰も選ばない" font_color=black size=23 width="200" x=550 y=&f.common_9_1_y_right graphic="select_waku_x500.png"]
[endif]
[s]
