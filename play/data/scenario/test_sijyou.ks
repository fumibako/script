...
[glink target="test5_1" text="5月(磯野に相談)" graphic="select_waku_x500.png" size=20 width="250" x=100 y=150 color=white]
...
[glink target="n_skip_plg" text="プロローグスキップテスト" graphic="select_waku_x500.png" size=15 width="250" x=400 y=350 color=blue]
