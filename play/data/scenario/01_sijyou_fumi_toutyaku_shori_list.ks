...
//↓配列情報(全手紙：攻略対象固有ナンバー(0=黒田、1=財前、2=四条、3=葛城宮、4=藤枝))を追加
...
//↓配列情報(攻略対象全手紙の到着未着情報管理配列の[2](←手紙それぞれに例えば黒田では「つばめの季節」=[2]、「ヤマアジサイ」=[3]などラベルのナンバーと一致させています)を0→1に。到着=1or未着=0)
//↓この[2]は上で出てきた手紙の"位置ナンバー"とは異なります。このへんがややこしく、すみません
