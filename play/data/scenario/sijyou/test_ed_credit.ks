...
[mtext text="ティラノスクリプト様" layer=27 size=&tf.fs x="&tf.left_x" y=210 color=snow in_effect="fadeIn" out_effect="fadeOut"]


[mtext text="スクリプト関係" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y1 color="snow" in_effect="fadeIn" out_effect="fadeOut" wait=false]

[mtext text="keito-works 様" layer=27 size=&tf.fs x="&tf.left_x" y=250 color=snow wait=false]
[mtext text="アオイサクラ 様： 簡易コンフィグ画面プラグイン" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y2 color=snow wait=false]
[mtext text="ティラノスクリプト 製作テクニックwiki 様" layer=&tf.fs size=18 x="&tf.left_x" y=&tf.top_y3 color=snow  in_effect="fadeIn" out_effect="fadeOut" wait=true]



[mtext text="背景1" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y1 color="snow" in_effect="fadeIn" out_effect="fadeOut" wait=false]
[mtext text="和風素材.com 様" layer=27 size=&tf.fs x="&tf.left_x" y=250 color=snow wait=false]
[mtext text="ゆうあかり 様" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y2 color=snow wait=false]
[mtext text="赤いガラスの宮殿 様" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y3 color=snow  wait=false]
[mtext text="フリー素材屋Hoshino 写真提供者 usagi_s 様" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y4 color=snow  wait=false]
[mtext text="flickr : Eddy BERTHIER 様" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y5 color=snow wait=false]
[mtext text="flickr : Liquid 様" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y6 color=snow wait=false]
[mtext text="flickr : DncnH 様" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y7 color=snow wait=true]
...
;サイズ15
[mtext text="pixiv : mit81 様, アスカ 様, ポテ子 様" layer=27 size=&tf.fs2 x="&tf.left_x" y=&tf.top_y4 color="snow" wait=true]
...
[mtext text="cssスクリプト" layer=27 size=&tf.fs x=&tf.left_x y=&tf.top_y1 color="snow" in_effect="fadeIn" out_effect="fadeOut" wait=false]
[mtext text="coliss 様" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y2 color="snow" wait=true]



[mtext text="原案・企画" layer=27 size=&tf.fs x=&tf.left_x y=&tf.top_y1 color="snow" in_effect="fadeIn" out_effect="fadeOut" wait=false]
[mtext text="◆/99/KAMIYU、◆8EASfQr/2Q、淑女の皆様" layer=27 size=&tf.fs x="&tf.left_x" y=&tf.top_y2 color=snow wait=true ]
　
...
[mtext text="エリ花様、黒田ルート添削・校正者様、登場人物名付け親様、テストプレイヤーの皆様、淑女の皆様" layer=27 size=tf.fs x=&tf.left_x y=&tf.top_y2 color=snow wait=true ]
