...
[endmacro]
;==================================================
;↓macro_etc.ksに[四条イベントシーン構築][四条ボタン表示]を追加しましたので、こちらをコメントアウトして動作確認してみます。確認後消去予定です。
;マクロ作成と自然で軽い表示の試みをありがとうございます(スクリプト担
;◆[四条イベントシーン構築]
...
;[endmacro]
;==================================================
;主人公プリロード　タイトル前にした方がいいかも→first.ksに追加しましたので、こちらは消します。ありがとうございます(スクリプト担
;==============================================================
;全てはここにGoします
[return]
