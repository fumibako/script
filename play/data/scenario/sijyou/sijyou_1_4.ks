...
[ruby text=じょ]女[ruby text=ちゅう]中[ruby text=がしら]頭と、やり取りをしている磯野以外、誰が教えて
[r]くれるだろうか。[p]
;否、誰に聞けるだろうか。
[whosay name=&sf.girl_namae color="#cf5a7f"]
[主人公通常]
...
[endif]
そんな店の前には、個性を得た[ruby text=かど]門[ruby text=まつ]松達が、[ruby text=ぎょうぎ]行[ruby text=ぎ]儀よく並んでいた。[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
[主人公ポーズ指]
...
[sp]話したがらない奴なんだ。　なればこそ、華織の妻となる君は、[r]
[sp]知っておくべきだ」[p]
;=================================================================================_
*seen4
[autosave]
...
今となっては、真剣な表情をした一華先生の講義に興味がそそられたのは、[r]
愛する人を想えば言うまでもない。[p]
[whosay name="四条 一華"]
[主人公目通常]
