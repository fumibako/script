...
[背景_青空]
[whosay name="華衣の婚約者]
『私の[ruby text=やまい]病のことで、[華衣]との婚約を解消されたら嫌だった。[r]
...
;↑"伝えられなくて"の方が良いのではないかとご意見をいただきました。華織の緊張や華衣との距離感の表現としてあえて"ら"を抜いている可能性を考えて、こちらでは修正しておりません ◆jsYiJcqRkk
[sp]けど、ずっと、ここにあったんだ……」
[autosave改]
[p]
[whosay name="華衣" color=%mp.color]
