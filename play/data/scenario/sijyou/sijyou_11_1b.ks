...
[whosay name="華織" color="olivedrab"]
『……君、体調の悪そうだけど大丈夫ですか？』[p]
;↑体調の→体調が　ではないか、とご意見をいただきました。変更しても大丈夫でしょうか？
;華織の動揺を表現する意図で、あえて書かれている可能性を考えてこちらでの修正はしておりません◆jsYiJcqRkk
[whosay name="華織" color="olivedrab"]
...
;↑「婚約を解消」もしくは「婚約解消を」のように「を」を入れて頂けたほうが読みやすい、とのご意見をいただきました。このままでも問題ありませんので、こちらでは修正しておりません◆jsYiJcqRkk
