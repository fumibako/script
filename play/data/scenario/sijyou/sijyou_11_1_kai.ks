...
「もう、そんなこと言って！　それよりも来週からは、[ruby text="いち"]一[ruby text="か"]様が、本格的に[r]
[sp]外交官として活躍したら有名になってしまったらお見掛けすることも[r]
[sp]できなくなってしまうわ」[p]
[whosay name="女中・その壱" color=%mp.color]
「あら！　あなた[ruby text="いち"]一[ruby text="か"]華様のことと。[ruby text="か"]華[ruby text="おり"]織様のこと、どちらも気にしてたの？」[p]
[whosay name="女中・その弐" color=%mp.color]
「それはソレ。これはコレ。[r]
