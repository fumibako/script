...
三男の[華衣]、四女 [ruby text="み"]美[ruby text="はな"]華の四兄弟。
;↑他のイベントに合わせて"みはな"と変更させていただきます◆jsYiJcqRkk
[autosave改]
[p]
;名前を出す必要は・・・ディティール？
[if exp="sf.BGM=='ON'"]
...
早いところ落ち着いてほしいと考え、若干早めの見合い話を持ってきた。
[autosave改]
[p]
...
;相思相愛のイメージ画像が(あれば…)
[whosay name="華織" color="olivedrab"]
「[華衣]も、彼女の深い優しさに惹かれ、相思相愛の仲になっていたよ」[p]
;////////////////////////シーン完全に現時間に戻る////////////////////
[暗転２]
[イベントシーン構築ボタン無し版]
;【背景】料亭
...
華織様は、目を伏せると、先日の[華衣]様とのやり取りについて語った。[p]
[cm]
...
;目的を語る
[whosay name="華織" color="olivedrab"]
「だからこそ、出て行った[華衣]に対して……僕は[ruby text="ざん"]懺[ruby text="げ"]悔をしないと[r]
