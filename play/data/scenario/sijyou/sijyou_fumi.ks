...
祖父にお前は、『平均的に何でもこなすが特出したものがない』って[r]
言われるから。[r]
[r]
[sp]　　　　　　　　　　　　　　　　　　　　　　　　四条 華織[p]
...
聞いたところ、外敵に襲われないように冬の海の上をスレスレに飛んで[r]
渡ってくるそうです。[r]
...
チューリップを巡ってチューリップバブルが起きたこともあるそうです。[r]
...
;『結納』[p]
;[手紙四条 fumi_number=]
;3月には、いよいよ[名前]との結納ですね。 [r]
;[名前]はどんな気持ちでいますか？ [r]
;感謝の言葉と、これから迷惑をかけるお詫びとで入り混じりますが、[r]
;たくさんの[名前]との思い出を綴っていきたいです。[r]
;他にも伝えたいことはありますが、それは結納の時の為にとっておきます。[r]
;[sp]　　　　　　　　　　　　　　　　　　　　　　　　四条 華織[p]
;[手紙四条読了 fumi_number=]
;///////エンド前への手紙おわり///////
;///////疎遠になったワケへの手紙///////
...
;あまり話さなくなってしまいましたが、これからは、[名前]さんと
;色々なことを話していきたいです[p]
;11行目で改ページで新たな真実笑
;追伸。気づいてるかもしれないけど、実をいうと文章を書くのは[r]
;苦手で、いつも綺麗な返信を送ってくれる[名前]には、頭があがら
;ないよ。[r]
;その代わりといっては、なんですが、ひとつ[名前]にさんと、約束します。
;[r]
;僕の中にひとつ極めるものを見つけると。[r]
;[sp]　　　　　　　　　　　　　　　　　　　　　　　　四条 華織[p]
;[手紙四条読了 fumi_number=]
;追伸は、他の手紙の整合あわせなのだ・・・なのだ・・・
;///////疎遠と懺悔の手紙おわり///////
;///////一歩進んでいるよとの手紙///////
