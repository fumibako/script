...
[s]
*sijyou_kazoku_2_3_2
妹の美華は、ひとつ上の兄の[華衣]に怯える気弱な[r]
子なんだ。 [r]
昔から、[華衣]と折り合いが悪くって、寄宿舎に入れられている。[r]
[r]
[華衣]と一緒に留学までしたけれど、やっぱり苦手みたいだ。[r]
...
ホッとする幸せを届けてくれる[名前]さんは春の天人ではないか[r]
などと考えてしまいます。[r]
[r]
[sp]　　　　　　　　　　　　　　　　　　　　　　　　四条 華織[p]
;//////////////////////////////////////////////////////////////////
...
苦手で、いつも綺麗な返信を送ってくれる[名前]さんには、頭が[r]
あがらないよ。[r]
[r]
...
[r]
さて、この度、四条華織は、[名前]さんとのお約束どおり、[r]
祖母の開いた華道競合会にて大賞受賞を果たしました。[r]
場所が場所だけに七光りと思われがちですが、[r]
祖父にも、来ていただいた方にも心にくる華だと褒めていた[r]
だきました。[r]
[glink target=18_ex_fumi_in2 text="→" size=10 x=770 y=300 graphic="select_waku_x150.png" width=40 height=15 font_color=black]
[s]
*18_ex_fumi_in2
[er]
もう、何も迷うこともない。[r]
...
[r]
[sp]　　　　　　　　　　　　　　　　　　　　　　　　四条 華織[r][r]
[glink target=18_ex_fumi_in1 text="←" size=10 x=110 y=300 graphic="select_waku_x150.png" width=40 height=15 font_color=black]
