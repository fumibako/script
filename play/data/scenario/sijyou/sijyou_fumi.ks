...
[r]
祖父の名前は『四条源次郎』祖母 『四条綾花』。[r]
二人は従妹で、もともとの華道業は祖母の家業なんだ。[r]
祖父は、厳格な人柄だけど、何故か祖母には頭が上がらないんだ。[p]
父の名前は『四条悠次郎』。新聞と珈琲が好きなおっとりした人かな。 [r]
実は祖父が英語が苦手みたいで、さりげなくサポートをしているようなんだ。[r]
君のお父さんとも仲がいいね。[p]
母の名前は『四条夏子』。華道家元の後藤家の四姉妹の長女で、[r]
長女故に末っ子には厳しくも甘いかも。[r]
母の趣味は三味線。狐目を気にしていて、最近怪しい化粧品店に行きたがるんだ。[r]
止めるのに苦労しているよ。[p]
祖父母も君のことを気に入っていたよ。[r]
[r]
次の手紙では、兄弟のことも書こうか[r]
