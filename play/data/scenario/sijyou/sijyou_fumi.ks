...
[名前]さんへ[r]
手紙をありがとうございます。[r]
将来、これからの事について考えると、色々と思うことがありますね。[r]
僕は、[名前]さんと共に将来を歩むために為すべきことをしなくてはいけません。[r]
悩むことはありますが、これは幸せな未来に向かうための始まりなのでしょうね。[r]
[名前]さんの将来の夢はありますか？[r]
[else]
[名前]へ[r]
[r]
...
[r]
暑さも薄まりもうすぐ秋になりますね。[r]
美しいネリネの花が咲く時期が来ました。[r]
ネリネの花言葉を知っていますか？[r]
「華やか」「また会う日を楽しみに」「幸せな思い出」[r]
「輝き」「忍耐」「箱入り娘」だそうです。[r]
[r]
花びらに光が当たると、キラキラと輝く不思議な花です。[r]
[sp]　　　　　　　　　　　　　　　　　　　　　　　　四条 華織[p]
;//////////////////////////////////////////////////////////////////
;◆↓お稽古パート経由で手紙を読みに来た場合の処理(手紙組み込みテスト用)
[if exp="tf.okeiko_gamen==true"]
