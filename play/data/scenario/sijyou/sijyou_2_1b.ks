...
;~~~~~~~~~~~~~~敵との立ち位置心情・説明シーン１~~~~~~~~~~~~~~~~~~~~~
#
教室の廊下に視線を流すと、ぐったりと肩を落として湖池屋令嬢を見つめる先生達が待ちかねていた。
[autosave改]
[p]
[whosay name=華道の先生 color=%mp.color]
「あの、そろそろ……」[p]
...
[主人公目伏]
「私、花と絵画が好きですの。 [r]
[sp]今日のお稽古に華織様も、ご一緒にして下さったら、とても心強いわ」
[autosave改]
[p]
...
[whosay name=湖池屋男爵令嬢 color=%mp.color]
[四条_隣_憂い]
「私、今年で[ruby text=じゅう]十[ruby text=なな]七となります。[sp]中々の歳でしょう？」
[autosave改]
[p]
;いきなり歳をきくなら名乗ってみたら？
[whosay name="華織" color="olivedrab"]
...
[ruby text=つか]掴み[ruby text=どころ]所のない[r]気持ちを打ち明けることにした。
[autosave改]
[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
[主人公横伏目]
