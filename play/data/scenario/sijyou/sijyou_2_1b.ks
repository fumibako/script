...
ご挨拶遅れまして大変、[ruby text=いた]致しました。 四条華織と申します。[r]
...
[whosay name=湖池屋男爵令嬢 color=%mp.color]
「ご丁寧にありがとうございます。[r]
[sp]いいんですの、私、お稽古以外では外に出れない身ですので、無理もないこと。[r]
[sp]それに、この教室は、知名度のために先生の名で、お貸しておりますし」[p]
[whosay name=湖池屋男爵令嬢 color=%mp.color]
「華織様のような方が、挨拶を遅れるのも[ruby text=いた]致し方ありません」[p]
;律儀な　礼節をわきまえた方　を重んじる
#
湖池屋令嬢は、長いまつ毛を落として、艶やかに溜息を落とした。[p]
[主人公目伏]
[whosay name="華織" color="olivedrab"]
「そうでしたか」[p]
;（はやくおわらないかなー）
...
[sp]でも、四条家の名誉の為なら、もしかしたら、行ってしまうのかもしれない)[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
