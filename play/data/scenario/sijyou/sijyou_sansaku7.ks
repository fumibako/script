...
#
私は、公衆の面前だというのに自然と華織様と手を[ruby text=つな]繋いでいたことに[r]
気づいてしまった。
[autosave改]
[p]
;暫定ト書き
小さな町中では、こっそりと手を繋ぐことができても、こういった男女が[r]
多い場所で人目を[ruby text=はばか]憚らず[ruby text=つな]繋ぐのは、はじめてのこと。[r]
意識してしまうと、とても恥ずかしい。[p]
[主人公目伏柔]
[whosay name=&sf.girl_namae color="#cf5a7f"]
(けど、これからは、ずっと繋いで歩けるのでしょうか） [p]
#
昔、見た恋絵巻を見てるような出来事が、[r]
...
[whosay name="調香店主" color=%mp.color]
「なんたって、華道の名士の”四条綾花様”が店内のに華を添えて[r]
...
[wait time=10]
#
調香店の店主は、いくつか持ち出してくると、私達の前に小瓶を並べる。[p]
