...
#
紗代子さんは、のんびりと磯野が出したナスやキュウリの漬物を食べながら独りごちた。[p]
[whosay name="飛鳥伯父様"]
「こら、紗代子。はしたないぞ」[p]
[whosay name=&sf.father_name color="DarkSlateBlue"]
...
「宜しいのでしょうか？」[p]
[whosay name=&sf.father_name color="DarkSlateBlue"]
「私も久しぶりに話したい。　妻も喜ぶ。どうだろうか？」[p]
[whosay name="飛鳥伯父様"]
「……ありがとうございます。 お言葉に甘えさせて頂きます」[p]
[whosay name=&sf.father_name color="DarkSlateBlue"]
「磯野、用意してやってくれ」[p]
[whosay name="磯野" color="dimgray"]
「それでは、そのように支度しましょう。[r]
[sp]朝までに、飛鳥御当主様が好きな[ruby tex=かい]開[ruby tex=ぎょう]堯[ruby tex=どう]堂のシウクリームを[r]
[sp]用意しておきましょうか？[p]
;お爺様宛
