...
[sp]ちなみに飛鳥家は、人生のうちで必ず[ruby text=かき]杜[ruby text=つばた]に似た女性を[r]
...
;主人公憂い
[whosay name=&sf.girl_namae color="#cf5a7f"] 
（……もしかして、飛鳥さんもその池に呼び寄せられているの？）
#
紗代子さんの言葉と怪談話が、私の中で[ruby text=つな]繋がってしまった[ruby text=と]途[ruby text=たん]端、[r]
私の背[ruby text=すじ]筋がゾッと寒くなりだした。[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
（そこまで計算された怪談なのかしら……？）[p]
;裏庭の杜若は？
[whosay name="飛鳥紗代子"]
「[ruby text=みな]皆の噂によると、
[ruby text=かき]杜[ruby text=つばた]若が、見[ruby text=ごと]事らしいですわ」[p]
「でも私、さしてお花に興味がないのに[r]
