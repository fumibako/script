...
;web版のお稽古ﾓｰﾄﾞ本編にてシーンジャンプが発生したため
@jump target="*test_end" cond="tf.test_gamen != true"
;===================================================
...
[whosay name=&sf.girl_namae color="#cf5a7f"]
「ええ！[sp]どうぞ。 [r]
[sp]丁度、目が[ruby text=さ]冴えて困っていたところでした。[r]
[sp]ですが……飛鳥伯父様とお休みになられなくて宜しいのですか？」[p]
[whosay name="飛鳥紗代子"]
...
「いえ、それなら紗代子さんの家の方が……」[p]
#
[ruby text=けん]謙[ruby text=そん]遜する紗代子さんに私が言葉をかけようとした時、[r]
紗代子さんは、何かを[ruby text=ひらめ]閃いたのか、明るい声を上げた。[p]
[whosay name="飛鳥紗代子"]
...
殿様の[ruby text=ご]御[ruby text=ちょう]寵[ruby text=あい]愛を受けていたの――。[p]
ところが殿様の長男も[ruby text=かき]杜[ruby text=つばた]若を愛するようになり、[r]
やがて[ruby text=かき]杜[ruby text=つばた]若は[ruby text=み]身[ruby text=ごも]籠もる。[p]
何も知らない殿様は、[ruby text=たい]大[ruby text=そう]層、喜ぶけれど、[r]
側近達は、口々に[r]
...
池に放り込んでしまったの。[p]
[sp][r]
このあと、この池の近くをとおった[ruby text=おく]奥[ruby text=がた]方様や[ruby text=そく]側[ruby text=しつ]室様は、[r]
釣られるようにして小舟に乗ってしまい[r]
思わぬ事故死を繰り返したそうよ……。[p]
;seが多めに鳴り続けている
[stopse]
;==========================================================
...
「！！」[p]
[whosay name="飛鳥紗代子"]
「どう？ これが飛鳥家に伝わる"昔話"よ」[p]
「ちなみに飛鳥家は、人生のうちで必ず[ruby text=かき]杜[ruby text=つばた]若に似た女性を[r]
...
;主人公憂い
[whosay name=&sf.girl_namae color="#cf5a7f"] 
（……もしかして、飛鳥さんもその池に呼び寄せられているの？）[p]
#
紗代子さんの言葉と怪談話が、私の中で[ruby text=つな]繋がってしまった[ruby text=と]途[ruby text=たん]端、[r]
背[ruby text=すじ]筋がゾッと寒くなりだした。[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
（そこまで計算された怪談なのかしら……？）[p]
;裏庭の杜若は？
[whosay name="飛鳥紗代子"]
...
「……」[p]
#
[ruby text=ぎ]疑[ruby text=しん]心の目で紗代子さんを見たが、[r]
いつも通り、紗代子さんは、表裏のない笑顔で話を進めた。[p]
;ある　ございますかしら？　ございますでしょう？
[whosay name="飛鳥紗代子"]
「[名前]さんの家には、何か、お話があるかしら？」[p]
「武家の家なら、こんな話より、[r]
[sp]もっと怖い話があるのでしょう？」[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
「えぇと……覚えがないのです、[r]
[sp]紗代子さん、ありがとうございます！[sp]私、充分に涼しくなったわ！」[p]
#
一瞬、あの客間の天井が脳裏に浮かんだが、[r]
布団をバサリと[ruby text=かぶ]被って口を[ruby text=つぐ]噤んだ。[p]
[whosay name="飛鳥紗代子"]
「そう？[r]
[sp][ruby text=かき]杜[ruby text=つばた]若さんのお話は、私にとっては聞き慣れた話だから[r]
[sp]イマイチですけれど……」[p]
[whosay name=&sf.girl_namae color="#cf5a7f"] 
;憂 目閉じ
「……」[p]
[whosay name="飛鳥紗代子"]
「ふう。[sp]わかりましたわ」[p]
「もう、[名前]さんは、充分な[ruby text=ご]御様子だから、ここまでにしますわね。[r]
...
;モヤモヤのイメージ
紗代子さんが話されたような[r]
愛憎の果てに無残な亡くなり方をされた家臣や、側室さまのこと……。[p]
"客間に宿る謎の怨霊"のこと。[p]
;天井背景に全画面？
...
[whosay name="飛鳥紗代子"]
「ああ、ごめんなさい！[r]
[sp]でも、怖くなった時は、大事な人のことを思い浮かべて寝るのよ」[p]
...
[endif]
[whosay name="飛鳥紗代子"]
「私の旦那様の[ruby text=もと]元[ruby text=おく]奥[ruby text=がた]方様は、若くして事故で[ruby text=な]亡くなられたの」[p]
「ですから私は、旦那様にとって[ruby text=に]二番目の[ruby text=おく]奥[ruby text=がた]方にあたるのですけど、[r]
[sp]こちらを向いて[ruby text=もら]貰うまで、大変、苦労しましたのよ」[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
「そうなのですか？」[p]
[whosay name="飛鳥紗代子"]
...
[sp]結婚当初も、私が他の方から"伯母"や"[ruby text=おく]奥[ruby text=がた]方"と呼ばれるのを[r]
[sp]苦言なされるほど、前の奥様を大切にされていたのよ」[p]
;苦言なされるほど　拒絶されるほど
[whosay name=&sf.girl_namae color="#cf5a7f"]
「そうでしたのね……」[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
（そういえば、三年ほど前に紗代子さんと出会った時……）[p]
（"まだ紗代子伯母さんとは呼ばないでね"……と言われて、[r]
...
;=============================
;■分岐処理　藤枝　葛城宮　その他　調整してください
[whosay name=&sf.girl_namae color="#cf5a7f"] 
;目閉じ照れなし
[if exp="(f.event_hujieda[4] == 1 && f.event_hujieda[17] != 1)"]
（恋ですか……）
[elsif exp="(f.katuraginomiya_only == 1 || f.katuraginomiya_fumi_start == 1)"]
（恋ですか……）
[else]
（共に歩む方との恋……）
[endif]
...
[sp]そうして、愛されてこそ、女性は美しくなるのよ」[p]
「死んでる方より、何事にも勝ると思わない？」[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
「そうかも……しれませんね」[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
...
[endif]
#
[ruby text=あ]彼の人を想えば、ずいぶんと心軽やかになったのであった。[p]
*end_Q
[whosay name=&sf.girl_namae color="#cf5a7f"]
「落ち着いて眠れそうです。[sp]おやすみなさいませ」[p]
[whosay name="飛鳥紗代子"]
「おやすみなさいませ。[sp]いい夢を」[p]
[fadeoutbgm time=3000]
[whosay name="飛鳥紗代子"]
