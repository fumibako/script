...
[主人公通常]
[wait time=10]
「ここには、小さな種類の[ruby text="バ"]薔[ruby text="ラ"]薇が植えてあるんだ。[r]
[sp]この[ruby text="バ"]薔[ruby text="ラ"]薇の花言葉は、『愛を持つ』『一時の感銘』で……」
[autosave改]
[p]
#
四条様は私の隣にたって、[ruby text="バ"]薔[ruby text="ラ"]薇について話しながら、[r]
出会った頃のように私の髪を撫でる。[p]
[四条目パチ1回]
[主人公目パチ1回]
...
そんな私を見た四条様は、何故かお顔を明るく[ruby text=かがや]輝かせた。[p]
[whosay name="四条 華織" color="olivedrab"]
