...
「お父様……！　はい、大丈夫です」[p]
[whosay name=&sf.father_name color="DarkSlateBlue"]
「[名前]のその表情、まるでお見合いの話を持ってきた時のようで懐かしいな」[p]
[whosay name=&sf.girl_namae color="mediumvioletred"]
「お父様……」[p]
[whosay name=&sf.father_name color="DarkSlateBlue"]
「話とは、[r]
...
[whosay name=お母様]
「[emb exp="sf.father_name"]さんはね、結婚してからも手紙を書いてくれるのよ」[p]
