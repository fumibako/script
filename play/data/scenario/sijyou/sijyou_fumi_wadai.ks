...
[glink target="*sincya_2" text="新茶２凡庸" graphic="select_waku_x500.png" size=20 width="250" x=100 y=200 font_color=black]
[glink target="*sincya_3" text="新茶３凡庸" graphic="select_waku_x500.png" size=20 width="250" x=100 y=250 font_color=black]
[glink target="*sincya_3_1" text="新茶凡庸A" graphic="select_waku_x500.png" size=20 width="250" x=100 y=300 font_color=black]
[glink target="*sincya_3_2" text="新茶凡庸A" graphic="select_waku_x500.png" size=20 width="250" x=100 y=350 font_color=black]
[glink target="*sincya_3_3" text="新茶凡庸B" graphic="select_waku_x500.png" size=20 width="250" x=100 y=400 font_color=black]
[glink target="*sincya_3_4" text="新茶凡庸B" graphic="select_waku_x500.png" size=20 width="250" x=100 y=450 font_color=black]

[glink target="*kuoku1" text="お気に入りの曲1" graphic="select_waku_x500.png" size=20 width="250" x=400 y=100 font_color=black]
...
*sijyou_fumi65
*syokuji
;散策イベント『食事』発生条件＝12月以降＝事件解決後のfumi67のみ実際のゲーム中では到着可能と思われます。
[if exp="f.okeiko_gamen != true"]
[テキスト全画面白文字]
[wait time=10]
『食事』[p]
...
[r]どうでしょうか？[r]
[r][名前]さんの初恋がどのようなものでしたか考えてしまいます。
[r]
[sp]　　　　　　　　　　　　　　　　　　　　　　　　四条 華織[p]
;◆↓お稽古パート経由で手紙を読みに来た場合の処理(手紙組み込みテスト用)
[if exp="f.okeiko_gamen == true"]
...
[endif]
[手紙四条 fumi_number=]
;01_sijyou_fumi_toutyaku_hantei.ksに「呼称呼び捨て」と書いていらっしゃいますが、この手紙だけ呼び捨てにする「見合い前」のためちゃん呼びにします◆jsYiJcqRkk
[名前]ちゃん。いつも手紙をありがとう。[r]
[r]
[r]
[r]
今日は、猫を見かけたかな？[r]
...
[名前]さんへ　手紙をありがとうございます。[r]
[r]
観劇について調べていたら、僕が好きな作曲家の曲を使用した[r]
オペラをやっているそうです。[r]
...
手紙ありがとう。友人についてだね。それなら[r]
文矢が一番の親友だよ。[r]
文矢は手紙に合う[ruby text=こころ]心[ruby text=ば]葉についてよく訊かれたよ、[r]
彼の朗らかなところが好きなんだよね[r]
[endif]
[r]
[sp]　　　　　　　　　　　　　　　　　　　　　　　　四条 華織[p]
...
*sijyou_fumi21
*sijyou_fumi104
;判定条件に(お見合い前→事件解決前のみへ変更)とありますので、お見合い前後どちらも対応できるようにします。◆jsYiJcqRkk
[if exp="f.okeiko_gamen != true"]
[テキスト全画面白文字]
[wait time=50]
『怪談話について』(お見合い前)
