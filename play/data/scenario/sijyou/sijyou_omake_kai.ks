...
「あーうるさい！」[p]
[whosay name="華織" color="olivedrab"]
「僕は[名前]さんと暮らす部屋の確認をするから、[whosay name="四条 華衣" color=%mp.color]は、適当にほしいものを持っていってくれ」[p]
[whosay name="四条 華衣" color=%mp.color]
「へい、へい」[p]
[whosay name="華織" color="olivedrab"]
...
[whosay name="四条 華衣" color=%mp.color]
「なぁ、俺に何ができるかな？ 華道もダメ、勉強もダメ。
そんな俺に出来ることって何がある？」[p]
#
[whosay name="四条 華衣" color=%mp.color]は、尋ねるように日誌を眺める。[p]
#日誌
