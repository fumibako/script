...
#
;ナレーターモノローグ
四条家と[名字]家の格式ばった挨拶が[ruby text="つつが"]恙[ruby text="な"]無く執り行われる。
[autosave改]
[p]
...
私はより一層、憧れの[ruby text="れん"]恋[ruby text="む"]夢が膨らんでいく。[p]
;[whosay name="幼い頃の私" color="#cf5a7f"]
...
;○友人ではあるので軽い形で。
[whosay name=&sf.girl_namae color="#cf5a7f"]
「はい。[sp]お兄様も、文通がうまくいって、とても喜んでいました」[p]
[chara_mod name="girl_kuti" storage="girl/S/kuti_futuu.png" time=0]
[wait time=10]
[四条微笑み]
[whosay name="四条 華織" color="olivedrab"]
「今の文矢は君に先輩風を吹かしているだろうけど」[p]
「あの時は、よく相談にのってほしいって[r]
...
#
;ナレーター
四条様は、袂をよせると花を[ruby text="すく"]掬うようにして私に手を差し伸べる。
[autosave改]
[p]
[chara_mod name="girl_me" storage="girl/S/me_ake.png" time=0]
[wait time=10]
...
[主人公通常]
（……ちがうわ。[r]
_　これからの私は、"華織お兄さま"ではなく、四条様の[ruby text="そば"]傍に）[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
;[主人公デフォルト]または
[主人公照れ目普通]
[chara_mod name="girl_kuti" storage="girl/S/kuti_ake.png" time=0]
[wait time=10]
「お兄様のようにと、おっしゃっていただきましたが[r]
[sp]四条様は、私とのことを兄に御相談されるのでしょうか？」[p]
[chara_mod name="girl_kuti" storage="girl/S/kuti_futuu.png" time=0]
[wait time=10]
#
私は、お兄様が四条様に接するように御言葉を返した。[p]
[whosay name="四条 華織" color="olivedrab"]
[四条眉驚き]
[四条目大]
「！」[p]
...
[wait time=10]
「ああ、ごめん。[sp][名前]ちゃんって呼んだ方が良かったかな」[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
;↓眉：強気 [主人公眉強気]
[chara_mod name="girl_mayu" storage="girl/S/mayu_tuyoki.png" time=0]
[wait time=10]
