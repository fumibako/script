...
[image name="loding_pic" layer=1 folder="image" storage="junbi_cyu.gif" left=860 top=600 ]
[stopbgm]
;///使用背景メモ　必要時に解放///////
...
[whosay name="四条 華織" color="olivedrab"]
「[名前]は、可愛らしい方ですね[r]
[sp]そうですね。 僕も、[名前]をひとりの女性として大切にしたい[r]
[sp]と思います」[p]
;態度を改ましょうか　敬愛
;わかりやすいセリフ
[chara_mod name="girl_mayu" storage="girl/S/mayu_yowa.png" time=0]
