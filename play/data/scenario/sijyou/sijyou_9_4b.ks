...
#
僕は[華衣]に伝えなければいけない言葉を反芻した。[p]
#
――どうか、私の想いを届けて下さい。[r]
[sp][華衣]様の幸せになれる日を待っていると。[r]
[sp]必ずこの想いを伝えて下さい。[p]
#
――それから華織さんも、[r]
[sp]必ず幸せになって[華衣]様を導いてあげて下さい。[p]
;==========================================================================
#
[背景_四条玄関]
[whosay name="華織" color="olivedrab"]
...
僕の手の中でズッシリと重さが生じた。[r]
この手紙は、四条家が長年[ruby text=つむ]紡いできた歴史そのものだったから。
[autosave改]
[p]
