...
;名前表示
[image name="c_name1" storage="../image/name_sijyou.png" layer=26 x=250 y=31 visible=true]
;達成数
...
;達成率
[ptext text="&tf.event_pasent" layer=26 size=30 x=600 y=31 color=snow]
[ptext text="%" layer=26 size=30 x=650 y=31 color=snow]
;イベント数　テスト用
