...
[wait time=10]
[image name="day,sansaku_7" storage="../image/day9_1.png" layer=26 x=&tf.x3 y=&tf.y7 visible=true wait=true]
[wait time=10]
;sansaku9
[image name="day,sansaku_9" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y8 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_9" storage="../image/day9_1.png" layer=26 x=&tf.x3 y=&tf.y8 visible=true wait=true]
[wait time=10]
;sansaku10
[image name="day,sansaku_10" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y1 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_10" storage="../image/day9_1.png" layer=26 x=&tf.x4 y=&tf.y1 visible=true wait=true]
[wait time=10]
;sansaku11
[image name="day,sansaku_11" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y2 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_11" storage="../image/day9_1.png" layer=26 x=&tf.x4 y=&tf.y2 visible=true wait=true]
[wait time=10]
;sansaku12
[image name="day,sansaku_12" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y3 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_12" storage="../image/day9_1.png" layer=26 x=&tf.x4 y=&tf.y3 visible=true wait=true]
[wait time=10]
;sansaku13
...
[button name="ending1" graphic="day_bad1.png" y="&tf.end1_y" x="&tf.x5" text="BAD1" size=15 target="sijyou_sinario_ed" exp="tf.jp_sinario='sijyou_10_3_badED'"]
[image name="ending1" storage="../image/day_check_sumi.png" layer=26 x="&tf.x7" y=&tf.y6 visible=true wait=true]
[wait time=10]
[else]
[image name="day,ending1" storage="../image/day_bad1.png" layer=26 y="&tf.end1_y" x="&tf.x5" visible=true wait=true]
[wait time=10]
[image name="ending1" storage="../image/day_check_mi.png" layer=26 x="&tf.x7" y=&tf.y6 visible=true wait=true]
[wait time=10]
[endif]

[if exp="sf.ED_sijyou_normal == 1"]
[button name="ending3" graphic="day_nomal.png" y="&tf.end2_y" x="&tf.x5" text="nomal" size=15 target="sijyou_sinario_ed" exp="tf.jp_sinario='sijyou_3_4_goodED'"]
[else]
[image name="day,ending3" storage="../image/day_nomal.png" layer=26 x="&tf.x5+10" y="&tf.end2_y" visible=true wait=true]
[wait time=10]
[image name="ending3" storage="../image/day_check_mi.png" layer=26 x="&tf.x7" y=&tf.y6 visible=true wait=true]
[wait time=10]
[endif]

[if exp="sf.ED_sijyou_good == 1"]
[button name="ending4" graphic="day_good.png" y="&tf.end2_y" x="&tf.x6" text="good" size=15 target="sijyou_sinario_ed" exp="tf.jp_sinario='sijyou_3_4_goodED2'"]
[else]
[image name="day,ending4" storage="../image/day_good.png" layer=26 x="&tf.x8" y="&tf.end2_y" visible=true wait=true]
[wait time=10]
[image name="ending4" storage="../image/day_check_mi.png" layer=26 x="&tf.x8" y=&tf.y6 visible=true wait=true]
[wait time=10]
[endif]
;====================================================================================================
...
[endscript]
[wait time=10]
[button name="btn,sijyou_sansaku7" graphic="day9_1.png" target="sijyou_sinario" x=&tf.x3 y=&tf.y7 exp="tf.jp_sinario='sijyou_sansaku7'"]
...
[endscript]
[wait time=10]
[button name="btn,sijyou_sansaku9" graphic="day9_1.png" target="sijyou_sinario" x=&tf.x3 y=&tf.y8 exp="tf.jp_sinario='sijyou_sansaku9'"]
...
[endscript]
[wait time=10]
[button name="btn,sijyou_sansaku10" graphic="day9_1.png" target="sijyou_sinario" x=&tf.x4 y=&tf.y1 exp="tf.jp_sinario='sijyou_sansaku10'"]
...
[endscript]
[wait time=10]
[button name="btn,sijyou_sansaku11" graphic="day9_1.png" target="sijyou_sinario" x=&tf.x4 y=&tf.y2 exp="tf.jp_sinario='sijyou_sansaku11'"]
...
[endscript]
[wait time=10]
[button name="btn,sijyou_sansaku12" graphic="day9_1.png" target="sijyou_sinario" x=&tf.x4 y=&tf.y3 exp="tf.jp_sinario='sijyou_sansaku12'"]
