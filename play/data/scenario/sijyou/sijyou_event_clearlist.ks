...
[image name="day,sansaku_6" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y1 visible=true wait=true]
[wait time=10]
[button name="btn,sijyou_sansaku6" graphic="day8_1.png" target="sijyou_sinario" x=&tf.x3 y=&tf.y1 exp="tf.jp_sinario='sijyou_sansaku6'"]
[image name="day,sansaku_6" storage="../image/day_check_sumi.png" layer=26 x="&tf.x3_sumi" y=&tf.y1 visible=true]
[else]
;sansaku6
[image name="day,sansaku_6" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y1 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_6,sijyou_sansaku6" storage="../image/day8_1.png" layer=26 x=&tf.x3 y=&tf.y1 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_6" storage="../image/day_check_mi.png" layer=26 x="&tf.x3_sumi" y=&tf.y1 visible=true]
[endif]
...
[image name="day,sansaku_1" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y2 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_1" storage="../image/day9_1_1.png" layer=26 x=&tf.x3 y=&tf.y2 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_1" storage="../image/day_check_mi.png" layer=26 x="&tf.x3_sumi" y=&tf.y2 visible=true]
[endif]

[if exp="sf.event_sijyou_sansaku_5 == 1"]
;sansaku5 sijyou_sansaku5.ks(9月～９月末　銀座デート前 b）or(11事件解決後～12月 a)
[image name="day,sansaku_5" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y6 visible=true wait=true]
[wait time=10]
[button name="btn,sijyou_sansaku5" graphic="day9_1_2.png" target="sijyou_sinario" x=&tf.x3 y=&tf.y3 exp="tf.jp_sinario='sijyou_sansaku5'"]
[image name="day,sansaku_5" storage="../image/day_check_sumi.png" layer=26 x="&tf.x3_sumi" y=&tf.y3 visible=true]
[else]
[image name="day,sansaku_5" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y3 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_5,sijyou_sansaku5" storage="../image/day9_1_2.png" layer=26 x=&tf.x3 y=&tf.y3 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_5" storage="../image/day_check_mi.png" layer=26 x="&tf.x3_sumi" y=&tf.y3 visible=true]
[endif]
...
[image name="day,sansaku_9" storage="../image/day_check.png" layer=26 x=&tf.x0_２ y=&tf.y4 visible=true wait=true]
[wait time=10]
[button name="btn,sijyou_sansaku9" graphic="day4_1_1.png" target="sijyou_sinario" x=&tf.x3 y=&tf.y4 exp="tf.jp_sinario='sijyou_sansaku9'"]
[image name="day,sansaku_9" storage="../image/day_check_sumi.png" layer=26 x="&tf.x4_sumi" y=&tf.y4 visible=true]
[else]
[image name="day,sansaku_9" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y4 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_9,sijyou_sansaku9" storage="../image/day4_1_1.png" layer=26 x=&tf.x4 y=&tf.y4 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_9" storage="../image/day_check_mi.png" layer=26 x="&tf.x3_sumi" y=&tf.y4 visible=true]
[endif]

;左位置3 tf.x0_2/tf.x3/tf.x3_sumi
[if exp="sf.event_sijyou_sansaku_10 == 1"]
;sansaku10　sijyou_sansaku10.ks(四条ルートのみ　四条の好感度が高い攻略のヒント)
[image name="day,sansaku_10" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y5 visible=true wait=true]
[wait time=10]
[button name="btn,sijyou_sansaku10" graphic="day4_1_2.png" target="sijyou_sinario" x=&tf.x4 y=&tf.y5 exp="tf.jp_sinario='sijyou_sansaku10'"]
[image name="day,sansaku_10" storage="../image/day_check_sumi.png" layer=26 x="&tf.x3_sumi" y=&tf.y5 visible=true]
[else]
[image name="day,sansaku_10" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y5 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_10,sijyou_sansaku10" storage="../image/day4_1_2.png" layer=26 x=&tf.x3 y=&tf.y5 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_10" storage="../image/day_check_mi.png" layer=26 x="&tf.x3_sumi" y=&tf.y5 visible=true]
[endif]
...
[image name="day,sansaku_3" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y5 visible=true wait=true]
[wait time=10]
[button name="btn,sijyou_sansaku3" graphic="day9_4.png" target="sijyou_sinario" x=&tf.x3 y=&tf.y5 exp="tf.jp_sinario='sijyou_sansaku3'"]
[image name="day,sansaku_3" storage="../image/day_check_sumi.png" layer=26 x="&tf.x3_sumi" y=&tf.y5 visible=true]
[else]
[image name="day,sansaku_3" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y5 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_3,sijyou_sansaku3" storage="../image/day9_4.png" layer=26 x=&tf.x3 y=&tf.y5 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_3" storage="../image/day_check_mi.png" layer=26 x="&tf.x3_sumi" y=&tf.y5 visible=true]
[endif]

;左位置3tf.x0_2/tf.x3/tf.x3_sumi
[if exp="sf.event_sijyou_sansaku_11 == 1"]
;sansaku11　　10/1_1
[image name="day,sansaku_11" storage="../image/day_check.png" layer=26 x="&tf.x0_2" y="&tf.y6" visible=true wait=true]
[wait time=10]
[button name="btn,sijyou_sansaku11" graphic="day10_1_1.png" target="sijyou_sinario" x=&tf.x3 y=&tf.y6 exp="tf.jp_sinario='sijyou_sansaku11'"]
[image name="day,sansaku_11" storage="../image/day_check_sumi.png" layer=26 x="&tf.x3_sumi" y=&tf.y6 visible=true]
[else]
[image name="day,sansaku_11" storage="../image/day_check.png" layer=26 x=&tf.x0_2 y=&tf.y6 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_11,sijyou_sansaku11" storage="../image/day10_1_1.png" layer=26 x=&tf.x3 y=&tf.y6 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_11" storage="../image/day_check_mi.png" layer=26 x="&tf.x3_sumi" y=&tf.y6 visible=true]
[endif]

;折り返し地点;左位置4 tf.x0_3 /tf.x4 /tf.x4_sumi
[if exp="sf.event_sijyou_sansaku_12 == 1"]
;sansaku12
[image name="day,sansaku_12" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y1 visible=true wait=true]
[wait time=10]
[button name="btn,sijyou_sansaku12" graphic="day10_1_2.png" target="sijyou_sinario" x=&tf.x4 y=&tf.y1 exp="tf.jp_sinario='sijyou_sansaku12'"]
[image name="day,sansaku_12" storage="../image/day_check_sumi.png" layer=26 x="&tf.x4_sumi" y=&tf.y1 visible=true]
[else]
[image name="day,sansaku_12" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y1 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_12,sijyou_sansaku12" storage="../image/day10_1_2.png" layer=26 x=&tf.x4 y=&tf.y1 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_12" storage="../image/day_check_mi.png" layer=26 x="&tf.x4_sumi" y=&tf.y1 visible=true]
[endif]

;tf.x0_3 /tf.x4 /tf.x4_sumi
[if exp="sf.event_sijyou_sansaku_4 == 1"]
;sansaku4 sijyou_sansaku4.ks(11月3週→12～1月末)　事件解決後の華衣のイベント
[image name="day,sansaku_4" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y2 visible=true wait=true]
[wait time=10]
[button name="btn,sijyou_sansaku4" graphic="day11_3.png" target="sijyou_sinario" x=&tf.x3 y=&tf.y2 exp="tf.jp_sinario='sijyou_sansaku4'"]
[image name="day,sansaku_4" storage="../image/day_check_sumi.png" layer=26 x="&tf.x4_sumi" y=&tf.y2 visible=true]
[else]
[image name="day,sansaku_4" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y2 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_4,sijyou_sansaku4" storage="../image/day11_3.png" layer=26 x=&tf.x4 y=&tf.y2 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_4" storage="../image/day_check_mi.png" layer=26 x="&tf.x4_sumi" y=&tf.y2 visible=true]
[endif]
...
[image name="day,sansaku_13" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y3 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_13" storage="../image/day10_1_3.png" layer=26 x=&tf.x4 y=&tf.y3 visible=true wait=true]
[wait time=10]
[iscript]
...
[endscript]
[wait time=10]
[image name="day,sansaku_13" storage="../image/day_check_mi.png" layer=26 x="&tf.x4_sumi" y=&tf.y3 visible=true]
[endif]
