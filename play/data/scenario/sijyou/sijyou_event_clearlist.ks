...
[endscript]
[image name="day,sansaku_10" storage="../image/day_check_sumi.png" layer=26 x="&tf.x4+140" y=&tf.y2 visible=true]
[else]
[image name="day,sansaku_10" storage="../image/day_check_mi.png" layer=26 x="&tf.x4+140" y=&tf.y2 visible=true]
[endif]
...
[endscript]
[image name="day,sansaku_11" storage="../image/day_check_sumi.png" layer=26 x="&tf.x4+140" y=&tf.y3 visible=true]
[else]
[image name="day,sansaku_11" storage="../image/day_check_mi.png" layer=26 x="&tf.x4+140" y=&tf.y3 visible=true]
[endif]
...
[endscript]
[image name="day,sansaku_12" storage="../image/day_check_sumi.png" layer=26 x="&tf.x4+140" y=&tf.y4 visible=true]
[else]
[image name="day,sansaku_12" storage="../image/day_check_mi.png" layer=26 x="&tf.x4+140" y=&tf.y4 visible=true]
[endif]
...
[endscript]
[image name="day,sansaku_13" storage="../image/day_check_sumi.png" layer=26 x="&tf.x4+140" y=&tf.y4 visible=true]
[else]
[image name="day,sansaku_13" storage="../image/day_check_mi.png" layer=26 x="&tf.x4+140" y=&tf.y4 visible=true]
[endif]
[s]
