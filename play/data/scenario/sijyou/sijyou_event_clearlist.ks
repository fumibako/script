...
;散策数
[ptext name="pasent" text="&tf.eventSansaku_Number_of_times" layer=26 size=25 x=745 y=80 color="khaki"]
[ptext name="pasent1" text="/12" layer=26 size=20 x=785 y=83 color="khaki"]
;====================================================================================================
