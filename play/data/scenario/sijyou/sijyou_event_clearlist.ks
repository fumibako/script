...
[image name="ending1" storage="../image/day_check_sumi.png" layer=26 x="&tf.x5+10" y=&tf.y6 visible=true wait=true]
[else]
...
;[else]
;[image name="day,ending2" storage="../image/day_bad1.png" layer=26 x="&tf.x5+10" y="&tf.end1_y" visible=true wait=true]
;[wait time=10]
;[endif]
...
[else]
[image name="day,ending3" storage="../image/day_good.png" layer=26 x="&tf.x6+10" y="&tf.end2_y" visible=true wait=true]
[wait time=10]
[endif]
;====================================================================================================
