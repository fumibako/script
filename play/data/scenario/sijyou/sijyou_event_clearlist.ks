...
[wait time=10]
;sansaku9
[image name="day,sansaku_9" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y1 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_9" storage="../image/day9_1.png" layer=26 x=&tf.x4 y=&tf.y1 visible=true wait=true]
[wait time=10]
;sansaku10
[image name="day,sansaku_10" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y2 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_10" storage="../image/day9_1.png" layer=26 x=&tf.x4 y=&tf.y2 visible=true wait=true]
[wait time=10]
;sansaku11
[image name="day,sansaku_11" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y3 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_11" storage="../image/day9_1.png" layer=26 x=&tf.x4 y=&tf.y3 visible=true wait=true]
[wait time=10]
;sansaku12
[image name="day,sansaku_12" storage="../image/day_check.png" layer=26 x=&tf.x0_3 y=&tf.y4 visible=true wait=true]
[wait time=10]
[image name="day,sansaku_12" storage="../image/day9_1.png" layer=26 x=&tf.x4 y=&tf.y4 visible=true wait=true]
[wait time=10]
;sansaku13
