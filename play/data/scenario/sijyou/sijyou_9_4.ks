...
[主人公目パチ1回]
#
[ruby text="さ"]桟[ruby text="じ"]敷き席に座っていた私は、隣に座る華織様の様子を[ruby text=うかが]窺った。[p]
...
#
[whosay name="おじさん" color=black]
「今日の『[ruby text=おん]音[ruby text=ど]頭[ruby text=こいの]恋[ruby text=ねた]寝[ruby text=ば]刃』は終わっちまったかい？[r]
...
私は、憧れの人の[ruby text="かたわ"]傍らで並んでいることに 緊張してしまい、[r]言葉も、ままならなかった。[p]
...
「[名前]が好きな帯留めはある？」[p]
#
ガラスの向こうに様々な種類の[ruby text="おび"]帯[ruby text="ど"]留めが並んでいる。[r]
[ruby text="うるし"]漆塗り、ハイカラなカメオ式、草木をモチーフとしたアールデコ調。[r]
家ではこんなに細かくは選べない。[p]
[主人公ポーズ片手]
[主人公驚]
[whosay name=&sf.girl_namae color="#cf5a7f"]
