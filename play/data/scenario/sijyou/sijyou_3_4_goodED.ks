...
;散策４　と　バザーを見ている またはバザーのみの場合
[if exp="(f.event_yukiyo == 1 && f.event_sijyou_4 == 1) || f.event_yukiyo == 1"]
[whosay name="四条幸代" color="#807070"]
「きっと貴方にも巡り会えますよ。 [華衣]様にも大事な人が 」[p]
[whosay name="四条幸代" color="#807070"]
「お二人を見て、そう思うなら、きっと」[p]
[whosay name="華衣" color=%mp.color]
「！　」[p]
...
すると、華やかな華織様のお顔が、[r]
そっと私の頬に寄り添い、愛情を込められたお言葉を耳元で[ruby text="ささや"]囁かれた。[p]
