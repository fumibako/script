...
[iscript]
tf.hint1="あるお稽古を(三週までに)2回以上で1度だけ発生";
tf.hint2="あるお稽古をを2回以上、手紙1通目を見ている場合に一度だけ発生";
tf.hint3="他の攻略対象より好感度が高いと発生";
tf.hint4="あるお稽古を2回以上、手紙2通目を見ている場合に一度だけ発生";
tf.hint5="あるお稽古を2回以上、手紙3通目を見ている場合に一度だけ発生";
tf.hint6="あるお稽古を2回以上、手紙4通目を見ている場合に一度だけ発生";
tf.hint7="手紙4通目を見ており「誰も選ばない」を選択場合に一度だけ発生";
tf.hint8="ルート確定後かつ九月二週に一度だけ発生";
tf.hint9="ルート確定後かつ九月四週に一度だけ発生";
tf.hint10="ルート確定後かつ十月一週に一度だけ発生";
tf.hint11="ルート確定後十月三週に一度だけ発生";
tf.hint12="ルート確定後十一月一週に一度だけ発生";
tf.hint13="ルート確定後十一月三週に一度だけ発生";
tf.hint14="ルート確定後かつ十二月三週に一度だけ発生";
tf.hint15="ルート確定後一月三週に一度だけ発生";
tf.hint16="ルート確定後二月三週に一度だけ発生";
//散策
tf.hint17="二月三週から三月四週の間に一度だけ発生";
//バザー
