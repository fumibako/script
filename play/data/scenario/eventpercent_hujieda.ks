...
tf.hint2="某手紙一通目を見ている必要があります。五月三週までにとあるお稽古を二回以上してみましょう";
tf.hint3="某手紙二通目までを見ている必要があります。他のお相手の好感度を8以下に抑えてみましょう";
tf.hint4="某手紙二通目までを見ている必要があります。六月三週までにとあるお稽古を二回以上してみましょう";
tf.hint5="某手紙三通目までを見ている必要があります。七月三週までにとあるお稽古を二回以上してみましょう";
tf.hint6="某手紙四通目までを見ている必要があります。八月三週までにとあるお稽古を二回以上してみましょう";
tf.hint7="某手紙四通目までを見ている必要があります。好感度30以上のお相手が居て「誰も選ばない」を選択した場合に個別ルートに進めます";
tf.hint8="個別ルートで、その週まで進めてみましょう";
tf.hint9="個別ルートで、その週まで進めてみましょう";
tf.hint10="個別ルートで、その週まで進めてみましょう";
tf.hint11="個別ルートで、その週まで進めてみましょう";
tf.hint12="個別ルートで、その週まで進めてみましょう";
tf.hint13="個別ルートで、その週まで進めてみましょう";
tf.hint14="個別ルートで、その週まで進めてみましょう";
tf.hint15="個別ルートで、その週まで進めてみましょう";
tf.hint16="個別ルートで、その週まで進めてみましょう";
//散策
tf.hint17="個別ルートで、二月三週～三月四週の間に散策へ出てみましょう";
//バザー
tf.hint18="個別ルートで、三月二週～三月三週までにとあるお稽古熟練度を70以上にしてみましょう";

tf.hint_bad="十一月一週に好感度が一定値未満の場合、badエンドになります";
...
tf.spoiler2="鳩の手紙一通目を見ている必要があります。五月三週までにお箏を二回以上お稽古してみましょう";
tf.spoiler3="鳩の手紙二通目までを見ている必要があります。他のお相手の好感度を8以下に抑えてみましょう";
tf.spoiler4="鳩の手紙二通目までを見ている必要があります。六月三週までにお箏を二回以上お稽古してみましょう";
tf.spoiler5="鳩の手紙三通目までを見ている必要があります。七月三週までにお箏を二回以上お稽古してみましょう";
tf.spoiler6="鳩の手紙四通目までを見ている必要があります。八月三週までにお箏を二回以上お稽古してみましょう";
tf.spoiler7="鳩の手紙四通目までを見ている必要があります。好感度30以上のお相手が居て「誰も選ばない」を選択した場合に藤枝様ルートに進めます";
tf.spoiler8="藤枝様ルートで、その週まで進めてみましょう";
tf.spoiler9="藤枝様ルートで、その週まで進めてみましょう";
tf.spoiler10="藤枝様ルートで、その週まで進めてみましょう";
tf.spoiler11="藤枝様ルートで、その週まで進めてみましょう";
tf.spoiler12="藤枝様ルートで、その週まで進めてみましょう";
tf.spoiler13="藤枝様ルートで、その週まで進めてみましょう";
tf.spoiler14="藤枝様ルートで、その週まで進めてみましょう";
tf.spoiler15="藤枝様ルートで、その週まで進めてみましょう";
tf.spoiler16="藤枝様ルートで、その週まで進めてみましょう";
//散策
tf.spoiler17="藤枝様ルートで、二月三週～三月四週の間に散策へ出てみましょう";
//バザー
tf.spoiler18="藤枝様ルートで、三月二週～三月三週までにお箏熟練度を70以上にしてみましょう";

tf.spoiler_bad="十一月一週に好感度40未満の場合、badエンドになります";
//十二月三週のイベントにて「話さない」を選択後、または好感度が30以下の場合、自動で分岐　好感度分岐はない
