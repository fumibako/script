...
[iscript]
tf.hint1="あるお稽古を(三週までに)二回以上で一度だけ発生";
tf.hint2="あるお稽古をを二回以上、手紙1通目を見ている場合に一度だけ発生";
tf.hint3="他の攻略対象より好感度が高いと発生";
tf.hint4="あるお稽古を二回以上、手紙2通目を見ている場合に一度だけ発生";
tf.hint5="あるお稽古を二回以上、手紙3通目を見ている場合に一度だけ発生";
tf.hint6="あるお稽古を二回以上、手紙4通目を見ている場合に一度だけ発生";
