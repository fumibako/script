...
[image name="day,katuragi_9_4" storage="../image/day_check_sumi.png" layer=26 x="&tf.x1+130" y=&tf.y7 visible=true]
[else]
[image name="day,katuragi_9_4" storage="../image/day_check_mi.png" layer=26 x="&tf.x1+130" y=&tf.y7 visible=true]
[endif]
...
[image name="day,katuragi_10_2" storage="../image/day_check_sumi.png" layer=26 x="&tf.x1+130" y=&tf.y8 visible=true]
[else]
[image name="day,katuragi_10_2" storage="../image/day_check_mi.png" layer=26 x="&tf.x1+130" y=&tf.y8 visible=true]
[endif]
...
[endscript]
[button name="katuragi_11_1" graphic="day11_1.png" target="katuragi_sinario" x=&tf.x2 y=&tf.y2 exp="tf.jp_sinario='katuraginomiya_11_1'"]
...
[endscript]
[button name="katuragi_11_4" graphic="day11_4.png" target="katuragi_sinario" x=&tf.x2 y=&tf.y3 exp="tf.jp_sinario='katuraginomiya_11_4'"]
...
[endscript]
[button name="katuragi_12_1" graphic="day12_1.png" target="katuragi_sinario" x=&tf.x2 y=&tf.y4 exp="tf.jp_sinario='katuraginomiya_12_1'"]
