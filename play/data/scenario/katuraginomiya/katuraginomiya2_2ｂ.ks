...
[whosay name="秘書" color=%mp.color]
「殿下、お話しがあります。[sp]……私も歳を取り、もう殿下を支える力はありません」[p]

[whosay name="葛城宮 晴仁" color=%mp.color]
[葛城宮驚き]
「何を言っている。[sp]柏木元大将の不正を追求出来たのは、お前の力でもある」[p]

[whosay name="秘書" color=%mp.color]
「はい、あの事件で痛感しました。[r]
[sp]私は、証拠一つ掴むのがやっとでした。[sp]明確な証言を得られたのは殿下の人望です」[p]

[whosay name="葛城宮 晴仁" color=%mp.color]
[葛城宮真剣]
「証拠をつかんだだけでも十分だ。[sp]そこから芋づる式に不正を暴けたのだから」[p]
...
[whosay name="秘書" color=%mp.color]
「はい、[r][sp]いずれ殿下には考えを同じくする者も信頼できる者も出るでしょう。[r]
...
[whosay name="秘書" color=%mp.color]
「はい、後任の者がまだいませんが、今の殿下ならきっとうまくやっていけるでしょう。[r]
