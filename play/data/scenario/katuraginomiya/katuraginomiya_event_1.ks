...
;[stopbgm]
;【BGM】黄金の国
;[playbgm storage="katuraginomiya_ougon.ogg" loop=true]
;[eval exp="f.bgm_storage='katuraginomiya_ougon.ogg'"]
;[endif]
...
……今はもう子供の頃の無邪気な笑みでなく優雅で優しく控えめな笑みになったと皆から言われるようになった。[p]
