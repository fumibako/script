...
;------------------------------------------------
[whosay name="葛城宮　晴仁" color=%mp.color]
「今から行われるこの会議は軍の兵達の指標となり、政治における軍の立場を[r]
[sp]決める重要なものであります」
[葛城宮口通常]
[p]
...
「旦那様が[ruby text="こう"]蟷[ruby text="もり"]螂[ruby text="だん"]団とも組み、反軍国主義の首相を暗殺する計画まで[r]
...
*seen7
#
[ruby text="こう"]蟷[ruby text="もり"]螂[ruby text="だん"]団は以前にも事件を起こしている。[r]
...
「……[ruby text="こう"]蟷[ruby text="もり"]螂[ruby text="だん"]団！ 」[p]
...
#
[ruby text="ぼう"]茫[ruby text="ぜん"]然と柏木元大将が呟く。[p]
;==========================================================================
;【背景】治安維持法
