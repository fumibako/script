...
[ruby text=じゅう]十あまりの[ruby text=しょう]床[ruby text=ぎ]几[ruby text=だい]台に赤[ruby text=もう]毛[ruby text=せん]氈が敷かれている。
[autosave改]
[p]
...
[whosay name="葛城宮　晴仁" color=%mp.color]
[葛城宮目伏せ照れ]
「君と会うのはあの[ruby text="バ"]薔[ruby text="ラ"]薇[ruby text="えん"]園以来か。[r]
...
[whosay name=？？？]
「いくら皇后陛下でもいつまでも、私を[ruby text="きん"]謹[ruby text="しん"]慎は出来ないでしょう。[r]
[sp]慈善活動に参加したいと申し出て[ruby text="きん"]謹[ruby text="しん"]慎を解いてもらったのですわ」[p]
...
[葛城宮目閉じ]
「ああ、[r]
[sp]自分の考え方を押し付けようとする、[ruby text="ごう"]傲[ruby text="まん"]慢な君とは違う」[p]
...
[whosay name=志津子女王]
「私は[名字]殿を認めませんわ。[r]
[sp]いきなり現れて晴仁親王をたぶらかした、[ruby text="げ"]下[ruby text="せん"]賤な方なんて！！」[p]
