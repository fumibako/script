...
色めき立ちもっと身分に相応しい婚約者を決めようとしているが、[r]
私が婚約したいのは君だけだ。[r]
[sp]私は君に婚約を申し込む。[r]
[r]
[sp][sp]近く、当家の主務事務官と宮内省の宗秩寮総裁が、[r]
[sp][sp][名字]家当主に婚約の申し込みをしに訪れる。[p]
[sp][r]
[r][r]
[sp]勿論私は君に無理強いはしたくない。[r]
...
;==========================スクリプトここまで=========================================================
;【テキスト全画面】黒茶・和紙風背景に白文字
数日後、葛城宮家の主務事務官と宮内省の宗秩寮総裁を迎え
婚約の申し込みをお受けした。[p]
[r]
「[ruby text=かしこ]畏きあたりの[ruby text=おぼ]思し[ruby text=め]召しにより、[r]
[sp]ご当家の長女・[名前]姫を葛城宮王妃にお迎え申し上げたい」[r]
[r]
「まことに一家一門の名誉。 [r]
[sp]ご無沙汰の趣、謹んで[ruby text=はいじゅ]拝受[ruby text=つかま]仕ります」[r]
[p]
お父様は私の幸せを願い、[r]
殿下らの婚約をお受けして下さった。[r]
...
[暗転]
;上に載っている画像が消えます。それまでに設定 イメージ画像などの背景を表示したい場合は実行する
;[freeimage layer = 29 time=1000]
[stopbgm]
...
[layopt layer=fix visible=true]
[eval exp="sf.FButton='ON'"]
;上に載っている画像が消えます。それまでに設定　イメージ画像などの背景を表示したい場合は実行しない
[freeimage layer = 29 time=1000]
;================================以降スクリプト担当====================================================
