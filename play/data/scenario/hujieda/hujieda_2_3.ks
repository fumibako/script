...
何かを返せるといいと書きました。今がそのときかも知れません。[r]
[r]
[sp]私も藤枝様の背中を押します。[r]
[r]
[sp]覚えておられるでしょうか？[r]
...
#
時子さんは、驚く私を横目に会場を仰ぎ見る。[r]
そして私の手を優しく引き、微笑んで言った。[p]
...
吸い込まれるようにして[ruby text="けん"]鍵[ruby text="ばん"]盤に指を置いた。[p]
...
「ですが、僕は[ruby text="ド"]独[ruby text="イツ"]逸留学を辞退します」[p]
...
[whosay name="音楽留学関係者"]
「[ruby text="せい"]静[ruby text="しゅく"]粛に！　
[stopse]
藤枝君それはどうしてかね？」[p]
