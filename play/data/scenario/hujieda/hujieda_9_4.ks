...
[whosay name="三宮　時子" color="#c25232"]
「……ああ、でも[ruby text="しゃく"]爵[ruby text="い"]位返上した藤枝家の御子息の噂は存じておりますわ。[r]
[sp]彼がピアノを弾かれている日曜日は予約なしでは入れないほどの人気で、[r]
[sp]とても素晴らしい演奏をされているそうですの」[p]
...
[sp]ですから[名前]さんの気持ちが本物の恋なら、その[ruby text="じょう"]成[ruby text="じゅ"]就を[r]
[sp]見てみたいと思いますわ」[p]
...
その音を頼りに歩くと、"ミルクホール月ノ光"の看板が目に入った。
[autosave改]
[p]
