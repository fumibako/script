...
[image name="day,hujieda_9_4" storage="../image/day_check_sumi.png" layer=26 x="&tf.x2+140" y=&tf.y1 visible=true wait=true]
[else]
[image name="day,hujieda_9_4" storage="../image/day_check_mi.png" layer=26 x="&tf.x2+140" y=&tf.y1 visible=true wait=true]
[endif]
...
[image name="day,hujieda_10_1" storage="../image/day_check_sumi.png" layer=26 x="&tf.x2+140" y=&tf.y2 visible=true wait=true]
[else]
[image name="day,hujieda_10_1" storage="../image/day_check_mi.png" layer=26 x="&tf.x2+140" y=&tf.y2 visible=true wait=true]
[endif]
...
[image name="day,hujieda_10_3" storage="../image/day_check_sumi.png" layer=26 x="&tf.x2+140" y=&tf.y3 visible=true wait=true]
[else]
[image name="day,hujieda_10_3" storage="../image/day_check_mi.png" layer=26 x="&tf.x2+140" y=&tf.y3 visible=true wait=true]
[endif]
...
[image name="day,hujieda_11_1" storage="../image/day_check_sumi.png" layer=26 x="&tf.x2+140" y=&tf.y4 visible=true wait=true]
[else]
[image name="day,hujieda_11_1" storage="../image/day_check_mi.png" layer=26 x="&tf.x2+140" y=&tf.y4 visible=true wait=true]
[endif]
...
[image name="day,hujieda_11_3" storage="../image/day_check_sumi.png" layer=26 x="&tf.x2+140" y=&tf.y5 visible=true wait=true]
[else]
[image name="day,hujieda_11_3" storage="../image/day_check_mi.png" layer=26 x="&tf.x2+140" y=&tf.y5 visible=true wait=true]
[endif]
...
[image name="day,hujieda_1_3" storage="../image/day_check_sumi.png" layer=26 x="&tf.x2+140" y=&tf.y7 visible=true wait=true]
[else]
[image name="day,hujieda_1_3" storage="../image/day_check_mi.png" layer=26 x="&tf.x2+140" y=&tf.y7 visible=true wait=true]
[endif]
...
[image name="day,hujieda_2_3" storage="../image/day_check_sumi.png" layer=26 x="&tf.x2+140" y=&tf.y8 visible=true wait=true]
[else]
[image name="day,hujieda_2_3" storage="../image/day_check_mi.png" layer=26 x="&tf.x2+140" y=&tf.y8 visible=true wait=true]
[endif]
;====================================================================================================
;判定処理をまとめます 散策
;2_3
