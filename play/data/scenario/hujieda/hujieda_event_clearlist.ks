...
[if exp="sf.ED_hujieda_normal == 1 || sf.ED_hujieda_good == 1 || sf.ED_hujieda_bad == 1 || sf.ED_hujieda_bad2 == 1 || sf.ED_hujieda_bad3 == 1"]
...
[button name="ending5" graphic="day_bad3.png" y="&tf.end1_y" x="&tf.x6" size=15 target="hujieda_sinario" exp="tf.jp_sinario='hujieda_8_4_bad'" width=&tf.end_day_width]
...
@jump storage="hujieda/hujieda_event_clearlist.ks" target=*replay_11_3bad
[endif]
...
@jump storage="hujieda/hujieda_event_clearlist.ks" target="stop"
[s]
...
[button name="spoiler_on" graphic="button_hinto_on.png" height=100 width=100 y=540 x=850 target="get_tips_label" exp="f.get_tips=2"]
[wait time=10]
;@jump storage="hujieda/hujieda_event_clearlist.ks" target="tips_btn"
@jump storage="hujieda/hujieda_event_clearlist.ks" target="stop"
