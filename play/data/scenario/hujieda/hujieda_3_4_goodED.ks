...
「何度もくじけそうになりましたが、４年間ずっと貴方のお手紙や[r]
[sp]思い出に支えられました」[p]
...
;[image layer=29 x=1 y=1 storage="bg/bg_EDsakura.jpg" time=1000 visible=true]
;【背景】ﾌﾟﾛﾛーｸﾞ
[image layer=29 x=1 y=1 storage="bg_prologue.jpg" time=1000 visible=true]
