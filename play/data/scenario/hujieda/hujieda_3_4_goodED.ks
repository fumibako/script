...
[主人公照れ]
[主人公目閉]
「ええ、お手紙に書いてありましたが、肇様が[ruby text="ド"]独[ruby text="イツ"]逸から[r]
...
[whosay name="藤枝 肇" color=%mp.color]
「遠い[ruby text="ド"]独[ruby text="イツ"]逸での留学は貴方への手紙にさえ書けない辛いこともありました。[r]
[sp]何度も挫折しかけたのです」[p]
...
[whosay name=&sf.father_name color="DarkSlateBlue"]
「肇君、君はいくつもの[ruby text="ヨー"]欧[ruby text="ロッ"]羅[ruby text="パ"]巴のコンクールに入賞し、[r]
[sp]父君は楽器の工房を立ち上げているそうだね」[p]

[whosay name="藤枝 肇" color=%mp.color]
「はい、ご[ruby text="ひ"]贔[ruby text="いき"]屓頂いてる皆様のお陰で、工房を大きくする予定です」[p]
...
[whosay name="藤枝 肇" color=%mp.color]
「ありがとうございます！[r]
[sp]これからも、[名前]さんを幸せにする為に精一杯努力します」[p]
