...
#
お父様は目を見開いて私を見た。[p]
そして、[ruby text="く"]苦[ruby text="もん"]悶するように目を閉じた。[r]
悩ませているのは私なのだから心苦しい。[p]

[whosay name=&sf.father_name color="DarkSlateBlue"]
「彼が、国費での[ruby text="ド"]独[ruby text="イツ"]逸留学をする話が出ていることを[r]
[sp]知っているか？」[p]
...
[whosay name=&sf.father_name color="DarkSlateBlue"]
「彼は家の事情を[ruby text="かんが"]鑑みて遠慮していたが、家族も留学を[r]
[sp]応援されているそうだ。[r]
[sp][名前] 、諦めなさい」[p]
...
[主人公困り]
[主人公口開]
「それなら[ruby text="ご"]後[ruby text="しょう"]生です、[r]
...
[主人公憂い]
[whosay name="藤枝 肇" color=%mp.color] 
「いずれこうなるとわかっていながら、僕の[ruby text="わが"]我[ruby text="まま"]儘で、すみません」[p]
[藤枝口通常]
[whosay name=&sf.girl_namae color="#cf5a7f"]
;【立ち絵】主人公：憂い
[主人公憂い]
...
[sp][ruby text="ド"]独[ruby text="イツ"]逸留学というのは本当ですか？」[p]
[主人公口通常]
