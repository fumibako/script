...
[whosay name=&sf.girl_namae color="#cf5a7f"]
「いえ、あの私は[名字][名前]です。[r]
[sp] 貴方のピアノが効きたくて、お兄様に連れてきていただいたのです」[p]
...
[whosay name="音楽学校教授"]
「いや、君を[r]
[sp] 国費での[ruby text="ド"]独[ruby text="イツ"]逸への音楽留学を推薦したのでその報告に」[p]
