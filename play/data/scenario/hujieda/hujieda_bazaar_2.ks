...
――華族会館。[r]
長屋門の奥に[ruby text="けん"]絢[ruby text="らん"]爛な洋館がそびえ立っている。[p]

かつて、政府の[ruby text="じゅう"]重[ruby text="ちん"]鎮達が、[r]
西欧諸国に我が国の発展を知らしめる為に造られた[r]
[ruby text="げい"]迎[ruby text="ひん"]賓館であり、諸外国を[ruby text="も"]模[ruby text="ほう"]倣し、舞踏会が[r]
開かれる場であった。[p]
...
*seen0
#
私は、ここで五日間、藤枝様の仕事前に数時間の合奏練習をすることに[r]なった。
[autosave改]
[p]
...
[sp][ruby text="う"]迂[ruby text="かつ"]闊な言動は、はしたないと思われる事になりかねませんからね」[p]
...
「あの……」[p]
#
私も[ruby text="こと"]箏を見つめ爪弾きながら、[ruby text=ささ]囁やきかえす。[p]
[whosay name=&sf.girl_namae color="#cf5a7f"]
[主人公目にこ]
「なんですか？」[p]
...
[主人公目閉じ]
#
オルガンの切ない伴奏はお[ruby text="こと"]箏の主旋律に寄り添い、次第に暖かなものへと[r]変わる。[p]
...
*seen8
#
――そして[ruby text=ふた]二つの音は溶け合っていく。[p]
...
#
私はその音につられるようにして自然とお[ruby text="こと"]箏をつま弾いていた。[p]
;================================================================
[暗転２]
;イメージ背景削除
...
「その昔、[ruby text="はな"]曄[ruby text="こ"]子と次郎という若い男女がいて、 [r]
...
[whosay name="青山男爵"]
「もし[ruby text="はな"]曄[ruby text="こ"]子が貧しさに耐える"強い心"があれば、[r]
[sp]もしくは[r]
