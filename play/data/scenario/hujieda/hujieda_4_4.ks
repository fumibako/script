...
[iscript]
f.fumi_all_title_new=f.okeiko_month_kansuuji+"「<ruby><rb>箏</rb><rt>こと</rt></ruby>の音に惹かれて」";//←仮タイトルです。お好みに変更してください
...
f.fumi_list_hujieda_title[0] = "四月 「<ruby><rb>箏</rb><rt>こと</rt></ruby>の音に惹かれて」";
