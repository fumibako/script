...
お母様は、公爵家の御令嬢でね。[r]
[r]
[ruby text="めかけ"]妾[ruby text="ばら"]腹ではあったけど本妻の子同然に育てられ[r]
...
[whosay name=文矢 color="#538a8a"]
「お祖父様が許すまで、[ruby text=ふた]二[ruby text=り]人とも時を待ったんだ」
[autosave改]
[p]
[主人公眉下げ下]
#
...
その後、お父様は東帝國大学に進み、[r]
文官高等試験に及第し、[r]
時の首相に見出されて[ruby text="ヨー"]欧[ruby text="ロッ"]羅[ruby text="パ"]巴に留学したんだ。[p]
...
[主人公効果消]
[主人公口通常]
その時、見知った女中の声が[ruby text="ふすま"]襖[ruby text="そと"]外から聞こえた。[p]
...
[font color=white size=27]
;====================================================================================
  生けられた[ruby text="ふ"]芙[ruby text="よう"]容の[ruby text="つぼみ"]蕾と艶やかに咲く花びらを見て、[r]
  私は、胸に手を当てた。 [p]
