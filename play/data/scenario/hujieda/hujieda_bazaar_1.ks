...
;【背景】背景ミルクホール
[chara_mod name="bg" storage="bg/I9IhvvVdPo/bg_fujieda_piano_1_1.jpg" time=100]
...
;背景変更:華族会館全画面
[image layer=29 x=1 y=1 storage="bg/I9IhvvVdPo/bg_fujieda_piano_1.jpg" time=50 visible=true]
[wait time=10]
;メッセージレイヤを全画面用に設定変更
...
[whosay name="藤枝 肇" color=%mp.color] 
「ありがとうございます。[r]
[sp]貴方は相変わらず理知的で人に対しても気遣いを忘れない方ですね」[p]
