...
[藤枝驚き]
「いえ、[r]
[sp]今年は経済的に色々あって、開催を危ぶまれていると聞きましたが[r]
[sp]開催されるんですか！」[p]
...
[whosay name="藤枝 肇" color=%mp.color] 
[藤枝困り]
「けれどお[ruby text="こと"]筝を弾いた母が居ません。[r]
[藤枝伏目]
[sp]ああ……でも……」[p]
...
[whosay name="財前美彬"]
「彼女も[ruby text="こと"]筝の上達が早く得意だと聞いてます。[r]
[sp]私が計らいましょうか？」[p]
...
[主人公眉下げ下]
[主人公目通常]
「……当家の[ruby text="しゅう"]醜[ruby text="ぶん"]聞になるやもしれませんし、旦那様は完全に[r]
