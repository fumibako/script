...
;心情を綺麗に見せたいので分けます
（藤枝様が[ruby text="ド"]独[ruby text="イツ"]逸に行かれたらもうお会いすることもない……）[p]
...
[主人公涙_目閉用]
#
時子さんに優しく言われ、私の[ruby text="るい"]涙[ruby text="せん"]腺は一気に緩む。[p]
...
;時間経過
;＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝－
時子さんの言葉に[ruby text="あん"]安[ruby text="ど"]堵した私は、今までの悲しみを吐き出すかのように[r]
して泣いた。[p]
