...
葛城宮9月1週(1見た,0未見)=[emb exp="f.event_katuraginomiya[3]"]　[r]
藤枝好感度=[emb exp="f.para_hujieda_koukando"]　藤枝ルート(1○,0×)=[emb exp="f.hujieda_au"]　箏回数=[emb exp="f.para_shujinkou_koto_kaisuu"][r]
葛城宮好感度=[emb exp="f.para_katuraginomiya_koukando"]　葛城宮ルート(1○,0×)=[emb exp="f.katuraginomiya_au"] 葛城宮のみ文通(1○,0×)=[emb exp="f.katuraginomiya_only"]
