...
if(f.wadai_list_hairetsu[f.wadai_number][0] == '家族について'){ //話題「家族について」を選択した場合、好感度に応じてその話題の返事待ちカウント(週数)スタート
	...
	if(f.para_sijyou_koukando >= parseInt(sf.sijyou['koukando_a'])){//好感度がsf.sijyou['koukando_a']以上なら、初期値より1週少なくセットします(が苦手な話題なので返事が1週遅い)
		f.sijyou_fumi_toutyakumachi_kazoku=f.sijyou_fumi_toutyakumachi - 1 + 1;
	}
...
f.sijyou_fumi_toutyakumachi_shumi=0;
f.sijyou_fumi_toutyakumachi_sigoto=0;
f.sijyou_fumi_toutyakumachi_kazoku=0;
f.sijyou_fumi_toutyakumachi_kisetsu=0;
f.sijyou_fumi_toutyakumachi_shourai=0;
f.sijyou_fumi_toutyakumachi_yuujin=0;
f.sijyou_fumi_toutyakumachi_shokuji=0;
f.sijyou_fumi_toutyakumachi_kangeki=0;
f.sijyou_fumi_toutyakumachi_neko=0;
f.sijyou_fumi_toutyakumachi_kiki=0;
f.sijyou_fumi_toutyakumachi_midori=0;
f.sijyou_fumi_toutyakumachi_photo=0;
f.sijyou_fumi_toutyakumachi_hajimari=0;
f.sijyou_fumi_toutyakumachi_music=0;
f.sijyou_fumi_toutyakumachi_michi=0;
f.sijyou_fumi_toutyakumachi_henka=0;
f.sijyou_fumi_toutyakumachi_dokusho=0;
f.sijyou_fumi_toutyakumachi_sports=0;
