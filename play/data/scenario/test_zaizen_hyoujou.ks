...
;[glink target="pose_03" text="[財前]" graphic="select_waku_x500.png" size=15 width="160" x=0 y=90 color=white]
;[glink target="pose_04" text="[財前]" graphic="select_waku_x500.png" size=15 width="160" x=0 y=120 color=white]

[glink target="face_01" text="[財前通常]" graphic="select_waku_x500.png" size=15 width="160" x=190 y=30 color=white]
[glink target="face_09" text="[財前冷ややか]" graphic="select_waku_x500.png" size=15 width="160" x=190 y=60 color=white]
[glink target="face_05" text="[財前冷ややかな微笑み]" graphic="select_waku_x500.png" size=15 width="160" x=190 y=90 color=white]
[glink target="face_06" text="[財前ため息]" graphic="select_waku_x500.png" size=15 width="160" x=190 y=120 color=white]
[glink target="face_07" text="[財前不快]" graphic="select_waku_x500.png" size=15 width="160" x=190 y=150 color=white]
[glink target="face_03" text="[財前驚き]" graphic="select_waku_x500.png" size=15 width="160" x=190 y=180 color=white]
...
[glink target="face_22" text="[財前伏目パチ1回]" graphic="select_waku_x500.png" size=15 width="160" x=0 y=270 color=white]

[glink target="face_23" text="[財前目閉じ]" graphic="select_waku_x500.png" size=15 width="160" x=0 y=300 color=white]

[glink target="face_24" text="[財前目を開く]" graphic="select_waku_x500.png" size=15 width="160" x=0 y=330 color=white]
...
[glink target="mayu_01" text="[財前眉通常]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=60 color=white]
[glink target="mayu_07" text="[財前眉ひそめ]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=90 color=white]
[glink target="mayu_06" text="[財前眉驚き]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=120 color=white]
[glink target="mayu_04" text="[財前眉強気]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=150 color=white]
[glink target="mayu_03" text="[財前眉困り柔和]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=180 color=white]
[glink target="mayu_02" text="[財前眉下げ]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=210 color=white]
[glink target="mayu_08" text="[財前眉冷ややか]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=240 color=white]
;[glink target="mayu_08" text="[財前眉下げ下]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=150 color=white]
[endif]

[if exp="f.gra_zaizen_part=='me'"]
[glink target="me_01" text="[財前目通常]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=60 color=white]
[glink target="me_02" text="[財前目大]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=90 color=white]
[glink target="me_03" text="[財前目にこ]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=120 color=white]
[glink target="me_04" text="[財前目伏]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=150 color=white]
[glink target="me_05" text="[財前目閉じ]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=180 color=white]
...
[glink target="kuti_01" text="[財前口通常]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=60 color=white]
[glink target="kuti_02" text="[財前口開]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=90 color=white]
[glink target="kuti_03" text="[財前口冷ややか]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=120 color=white]
...
[glink target="emo_01" text="[財前効果消]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=60 color=white]
[glink target="emo_02" text="[財前頬染め]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=90 color=white]
[glink target="emo_03" text="[財前汗]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=120 color=white]
;[glink target="emo_04" text="[財前ビンタ]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=150 color=white]
;[glink target="emo_05" text="[財前]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=180 color=white]
;[glink target="emo_06" text="[財前]" graphic="select_waku_x500.png" size=15 width="160" x=600 y=210 color=white]
