...
[sp]立たされているかだけでも感じて、お手紙を出したいと思います」[p]
;理解した上で
...
;【背景】銀行 全画面背景
[image layer=29 x=1 y=1 storage="bg_zaizen_ginkou_mae.jpg" time=1000 visible=true]
;【背景】町並み　ひとまず
[chara_mod name="bg" storage="bg_zaizen_ginkou_mae.jpg" time=50]
