...
[whosay name="三宮　時子" color="#c25232"]
;分けた方がいいかもしれません　例：まぁ端麗な容姿ですわよね。それに～です。ですが、[名前]さんは～と思いました。
「ええ、まあ端麗な容姿にしても、[r]
[sp]新華族に叙せられ、 身分も申し分のない方ですが[r]
...
[whosay name="三宮　時子" color="#c25232"]
「財前様のご家族は少し複雑でしてね。[r]
[sp]特にお祖母様が厳しい方だと聞くわ。[sp]お母様については、ご存じ[r]
[sp]ですか？」[p]
