...
[whosay name="三宮　時子" color="#c25232"]
「ええ、……まぁ端麗な容姿をされてますわね。[r]
[sp]それに新華族に叙せられ、身分も申し分のない方です」[p]
;容姿をされてますわね。
...
[whosay name=&sf.girl_namae color="#cf5a7f"]
[主人公憂い]
「お手紙で、真剣に私の考え方を知り試そうとされていました。[r]
[sp]……どんな方なのか会ってみたくなりましたの。」[p]
;真面目で→試されて　真面目にはかからないので分ける
;お手紙の　～から真面目な印象を受けました。　（時々/少し）試されている気もしたのですが[r]

[whosay name="三宮　時子" color="#c25232"]
「悪い人選ではないと思いますわよ。[r]
[sp]あの方は自分の妻になる方を蔑ろにするような方でも[r]
[sp]ありませんし」[p]
