...
#
お二方の視線が私の方へ向き、思わず[ruby text="うつむ"]俯く。[p]
;私はなくても
#
[主人公頬染め]
...
（彫の深い顔立ちに、なんて綺麗な[ruby text="あお"]碧い瞳！[r]
...
#
財前様が頭を下げ、そして私に目を向けた。[r]――視線が合う……けれど[ruby text="あお"]碧い瞳はどこか[ruby text="さ"]醒めていた。
[autosave改]
[wait time=10]
[p]
...
私は[ruby text="ぼう"]茫[ruby text="ぜん"]然とした。[p]
