...
[whosay name=磯野 color="dimgray"]
「お母様が[ruby text="ド"]独[ruby text="イツ"]逸出身の方で、偏見などに苦労されたそうでございます」[p]
[主人公伏目パチ1回]
[wait time=10]
[whosay name=&sf.girl_namae color="#cf5a7f"]
「そうなのですか」[p]
...
[whosay name=磯野 color="dimgray"]
「ですが、元より財前様は社交に長けた方だそうで、並々ならぬ努力された結果、[r]
[sp]現在の社交界での地位を築きあげられました」[p]
...
[whosay name=&sf.girl_namae color="#cf5a7f"]
;↓動作確認中、伏目→一度開いてから目パチとなって違和感があったため調整します◆jsYiJcqRkk
[主人公伏目パチ1回]
[wait time=10]
[主人公ポーズ通常]
[主人公憂い]
