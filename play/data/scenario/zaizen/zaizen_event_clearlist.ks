...
[button name="ending1" graphic="day_bad2.png" y="&tf.end1_y" x="&tf.x6" size=15 target="zaizen_sinario" exp="tf.jp_sinario='zaizen_11_1_bad1'"]
...
[button name="ending2" graphic="day_bad1.png" y="&tf.end1_y" x="&tf.x5" size=15 target="zaizen_sinario" exp="tf.jp_sinario='zaizen_11_bad2'"]
