...
[glink target=*qa text="Ｑ＆Ａ" font_color=black size=13 width="95" x=340 y=10 graphic="select_waku_x300b.png"]
...
<table border="0" style="margin-left:0%; margin-right:0%; width:100%;" align="left">
    <tr>
        ...
        　お好きな名前を入力して決定を押すと、物語が始まります。<br><br>
		</td>
    </tr>
</table>
<img src="./data/image/line_brown.png">
...
<table border="0" style="margin-left:0%; margin-right:0%; width:100%;" align="left">
    <tr>
        <th class="yohaku" scope="row"><h2 class="image">文箱</h2><img src="../ss_hp_game_fumibako.jpg" alt="文箱"><br><br></th>
        <td>
...
@jump storage="help_report.ks" target=*common
