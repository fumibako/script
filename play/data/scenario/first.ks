...
;メッセージレイヤの定義(画面全体）
[position layer=message0 width=960 height=550 top=50 left=150 page=fore opacity=0]
...
[ptext layer=14 text="・・・読込中・・・" y=100 x=0 color="white" width=960 align=center]
[wait time=50]
[r]
[wait time=50]
...
[wait time=10]
@layopt layer=15 visible=true
[freeimage layer = 15]
[ptext layer=15 text="20%" y=150 x=0 color="white" width=960 align=center]
...
[font color=white]
[freeimage layer = 15]
[ptext layer=15 text="40%" y=150 x=0 color="white" width=960 align=center]
...
[font color=white]
[freeimage layer = 15]
[ptext layer=15 text="60%" y=150 x=0 color="white" width=960 align=center]
...
[font color=white]
[freeimage layer = 15]
[ptext layer=15 text="80%" y=150 x=0 color="white" width=960 align=center]
;画像ファイルはフルパス（プロジェクトファイル以下）で指定してください
[iscript]
...
[font color=white]
[freeimage layer = 15]
[ptext layer=15 text="100%" y=150 x=0 color="white" width=960 align=center]
[freeimage layer = 14]
[freeimage layer = 15]
[ptext layer=15 text="・　click　・" size=32 y=100 x=0 color="white" width=960 align=center]
[ptext layer=15 text='PCでは"F11"キーを押すかアプリの"最大化"' y=150 x=0 color="white" width=960 align=center]
[ptext layer=15 text="スマホの方は横向きに持っていただくと" y=180 x=0 color="white" width=960 align=center]
[ptext layer=15 text="フルスクリーンでお楽しみいただけます。" y=210 x=0 color="white" width=960 align=center]
[ptext layer=15 text="(環境によりフルスクリーンにならない場合もあります)" y=240 x=0 color="white" width=960 align=center]

[ptext layer=15 text="設定によっては音が鳴ります" y=300 x=0 color="white" width=960 align=center]
[ptext layer=15 text="（タイトル画面右下で設定してください）" y=330 x=0 color="white" width=960 align=center]
;メッセージレイヤの定義(画面上部中央：位置調整用）
[position layer=message0 width=20 height=20 top=50 left=455 page=fore opacity=0]
[p]
