...
;メッセージレイヤの定義(画面全体）
[position layer=message0 width=960 height=550 top=80 left=150 page=fore opacity=0]
...
_　　PCでは"F11"キーを押すかアプリの"最大化"click[r]
_　　　　スマホの方は横向きに持っていただくと[r]
_　　　　フルスクリーンでお楽しみいただけます。[r]
_　　(環境によりフルスクリーンにならない場合もあります)[r]
[r]
_　　　　　　　　設定によっては音が鳴ります[r]
_　　　　　（タイトル画面右下で設定してください）[p]
[if exp="sf.BGM=='ON'"]
