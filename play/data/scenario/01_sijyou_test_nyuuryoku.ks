...
[ptext text="淑女度" layer=29 size=15 x=500 y=60 color=darkslateblue bold=bold]
[edit left=600 top=110 width=200 length=200 maxchars=3 name="f.para_shujinkou_shukujodo" height=20]
