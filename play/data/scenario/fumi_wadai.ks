...
[button fix=true name="list" folder="fgimage/button" graphic="button_close80x80.png" storage="fumi_henji.ks" target="*fumi_henji_owari" x=870 y=555]
[font size=25]
この内容で[r]
よいかしら？
...
[wait time=10]
		[glink name="list" storage="fumi_henji_binsen_sentaku2.ks" target=&f.binsen_viewing_target text="変更" size=20 width="40" x=750 y=105 graphic="select_waku_x150.png" font_color=black]
	[ptext name="list" text=&f.fumi_sentaku_gotyou layer=28 size=25 x=350 y=245 color=saddlebrown bold=bold]
[wait time=10]
		[glink name="list" storage="fumi_henji_gotyou.ks" target=*gotyou_sentaku text="変更" size=20 width="40" x=750 y=230 graphic="select_waku_x150.png" font_color=black]
	[ptext name="list" text=&f.fumi_sentaku_wadai layer=28 size=25 x=350 y=370 color=saddlebrown bold=bold]
[wait time=10]
		[glink name="list" storage="fumi_wadai_sentaku.ks" target=&f.wadai_viewing_target text="変更" size=20 width="40" x=750 y=355 graphic="select_waku_x150.png" font_color=black]
[button fix=true name="list" folder="fgimage/button" graphic="button_ok100x100.png" target="*fumi_ok" x=450 y=430]
[一斉表示]
[clearstack]
