...
[glink target=*jump_ok1 text="すぐに相談する（選択肢までスキップ）" font_color=black size=23 width="500" x=200 y=50 graphic="select_waku_x500.png"]
[glink target=*jump_to_end1 text="大丈夫（既読イベントスキップ）" font_color=black size=23 width="500" x=200 y=150 graphic="select_waku_x500.png"]
[glink target=*jump_no1 text="じっくり相談する（最初からイベントを見る）" font_color=black size=23 width="500" x=200 y=250 graphic="select_waku_x500.png"]
[s]
*jump_ok1
[er]
...
[wait time=10]
[whosay name=&sf.girl_namae color="#cf5a7f"]
「そうですのね。 　文箱は全てのお手紙が一覧で見られるようですけど、[r]
[sp]"情報"からですとお相手ごとにお手紙が見られるのですね」[p]
;↓口：通常 [主人公口通常]
[chara_mod name="girl_kuti" storage="girl/S/kuti_futuu.png" time=0]
[wait time=10]
[whosay name="磯野" color="dimgray"]
...
;◆↓どういうときに便利か具体的な例："文通開始1ヶ月でのセリフとして違和感"というご意見をいただいて、磯野からのヒントという形に変更いたしました◆jsYiJcqRkk
[whosay name="磯野" color="dimgray"]
「たとえば、同じ話題の手紙を何度もお送りされると、お返事の内容が[r]
[sp]変わる方もいらっしゃいます」[p]
[主人公目パチ1回]
[wait time=10]
[whosay name="磯野" color="dimgray"]
「新しい話題でお送りされる際にも、今までの話題を確認されたいことも[r]
[sp]ございますでしょうか」[p]

[whosay name=&sf.girl_namae color="#cf5a7f"]
「どなたにどのような話題を何度送ったか[r]
[sp]振り返りたいときも来るかもしれませんね」[p]

[whosay name="磯野" color="dimgray"]
「そのようなときに、"情報"や文箱の"履歴"がお役に立ちますよ」[p]
