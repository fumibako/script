...
//f.event_sijyou_4 == 1 || f.event_sijyou_kai_jijyou == 1) && f.sijyou_sobo != true && f.para_shujinkou_j_reihou >= 10"]
tf.hint13="十月一週に’尋ねている’、または、散策４をみているかつ礼法が10以上あり四条祖母とあっていない場合一回発生";
//散策
