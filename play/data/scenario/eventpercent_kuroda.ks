...
tf.hint_bad="十二月三週に淑女度又は好感度が低いか、麦の穂が無い(六月四週イベントを見ていない)とbadエンドになります";
...
tf.spoiler2="その週まで進行し「黒田様」を選びましょう。黒田様の個別ルートに進行します";
...
tf.spoiler_nomal="三月四週に好感度、淑女度、語学が80未満の状態で休憩するとnormalエンドになります";
