...
[if exp="f.midoku_list_hairetsu[f.fumi_hairetsu1][f.fumi_hairetsu2]>0"]
	[ptext name="list" text="未読" layer=28 size=15 x=500 y=&f.fumi_katuraginomiya_midoku_y color=mediumslateblue bold=bold]
[endif]
;◆返信ボタンを必要時に表示
...
[else]
	...
	[glink name="list" storage=&f.fumi_henji_storage target=&f.fumi_henji_target text="返信" exp="f.fumi_henjityu=1" size=16 width="32" x=860 y=&f.fumi_katuraginomiya_y graphic="select_waku_x135.png" font_color=black]
[endif]
;◆手紙タイトルを並べて表示
[if exp="f.fumi_katuraginomiya_number == 0"]
[else]
	[glink name="list" storage="katuraginomiya/katuraginomiya_fumi.ks" target=&f.fumi_list_katuraginomiya_target[f.list_count] text=&f.fumi_list_katuraginomiya_title[f.list_count] size=16 width="260" x=535 y=&f.fumi_katuraginomiya_y graphic="select_waku_x550_fuutou.png" font_color=black]
[endif]
