...
[wait time=10]
[glink target=*to_omake text="「おまけ」を見る" font_color=black size=20 width="400" x=100 y=200 graphic="select_waku_x500.png"]
[glink target=*to_title text="タイトル画面へ（ゲーム終了）" font_color=black size=20 width="400" x=100 y=400 graphic="select_waku_x500.png"]
